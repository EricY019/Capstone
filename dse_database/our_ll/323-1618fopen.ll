; ModuleID = 'code/323-1618fopen.c'
source_filename = "code/323-1618fopen.c"
...
@.str = private unnamed_addr constant [10 x i8] c"/tmp/file\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32 %2)
  br label %for.inc
