; ModuleID = 'code/045-18778Undefined.c'
source_filename = "code/045-18778Undefined.c"
...
define dso_local void @undefined_local() #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @some_calc(i32 %a) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %mul = mul nsw i32 %1, %2
  call void @some_calc(i32 %mul)
  call void @undefined_local()
  br label %for.inc
