; ModuleID = 'code/070-55782.c'
source_filename = "code/070-55782.c"
...
entry:
  ...
  store i32 4000000, i32* %N, align 4
...
while.end:                                        ; preds = %while.cond
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %8)
  ret i32 0
}
