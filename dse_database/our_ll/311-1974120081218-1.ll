...
entry:
  ...
  %0 = load i32, i32* getelementptr inbounds (%struct.A, %struct.A* @a, i32 0, i32 0), align 4
  ret i32 %0
}
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds i8, i8* bitcast (%struct.A* @a to i8*), i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  call void @bar()
  %4 = load i32, i32* getelementptr inbounds (%struct.A, %struct.A* @a, i32 0, i32 1), align 4
...
for.body16:                                       ; preds = %for.cond12
  ...
  %arrayidx18 = getelementptr inbounds i8, i8* bitcast (%struct.A* @a to i8*), i64 %idxprom17
