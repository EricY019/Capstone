...
if.then:                                          ; preds = %for.body3
  %6 = load i32, i32* %product, align 4
  %7 = load i32, i32* %large, align 4
  %cmp4 = icmp sgt i32 %6, %7
  br i1 %cmp4, label %if.then5, label %if.end

if.then5:                                         ; preds = %if.then
  %8 = load i32, i32* %product, align 4
  store i32 %8, i32* %large, align 4
  br label %if.end
...
for.end9:                                         ; preds = %for.cond
  %11 = load i32, i32* %large, align 4
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i32 %11)
