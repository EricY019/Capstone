...
@_g = dso_local global i8* getelementptr inbounds ([435 x i8], [435 x i8]* @.str, i32 0, i32 0), align 8
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx8 = getelementptr inbounds [1014 x i64], [1014 x i64]* @g, i64 0, i64 %idxprom7
...
for.inc:                                          ; preds = %for.body45
  ...
  %arrayidx49 = getelementptr inbounds [1014 x i64], [1014 x i64]* @g, i64 0, i64 %idxprom48
  ...
  %arrayidx52 = getelementptr inbounds [1014 x i64], [1014 x i64]* @g, i64 0, i64 %idxprom51
...
if.else57:                                        ; preds = %if.else15
  ...
  %arrayidx63 = getelementptr inbounds [1014 x i64], [1014 x i64]* @g, i64 0, i64 %idxprom62
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %arrayidx = getelementptr inbounds [1014 x i64], [1014 x i64]* @g, i64 0, i64 %add
...
entry:
  ...
  call void @gw(i64 3, i64 1, i64 9999)
  call void @gw(i64 4, i64 1, i64 2)
  br label %_1

_1:                                               ; preds = %_26, %if.then170, %entry
  call void @sa(i64 -1)
  %call2 = call i64 @gr(i64 3, i64 1)
  call void @sa(i64 %call2)
  call void @sa(i64 1)
  %call3 = call i64 @gr(i64 4, i64 1)
...
_3:                                               ; preds = %if.else
  %call6 = call i64 @sp()
  %call7 = call i64 @sp()
  store i64 %call7, i64* %v0, align 8
  %call8 = call i64 @sp()
  store i64 %call8, i64* %v1, align 8
...
_4:                                               ; preds = %if.then44, %_3
  %call9 = call i64 @sp()
  call void @gw(i64 1, i64 0, i64 %call9)
  call void @sa(i64 -1)
  %call11 = call i64 @sp()
  store i64 %call11, i64* %v010, align 8
  %call13 = call i64 @sp()
  store i64 %call13, i64* %v112, align 8
  %4 = load i64, i64* %v010, align 8
  call void @sa(i64 %4)
  %5 = load i64, i64* %v112, align 8
  call void @sa(i64 %5)
  br label %_5
...
_5:                                               ; preds = %if.then24, %_4
  ...
  %call16 = call i64 @sp()
  store i64 %call16, i64* %v015, align 8
  %call18 = call i64 @sp()
  store i64 %call18, i64* %v117, align 8
  %6 = load i64, i64* %v015, align 8
  call void @sa(i64 %6)
  %7 = load i64, i64* %v117, align 8
  call void @sa(i64 %7)
  %call19 = call i64 @sp()
  %div = sdiv i64 %call19, 10
  call void @sa(i64 %div)
  %call20 = call i64 @sr()
  call void @sa(i64 %call20)
  %call21 = call i64 @sp()
...
_8:                                               ; preds = %if.then33, %_7
  ...
  %call29 = call i64 @sp()
  call void @gw(i64 1, i64 0, i64 %call29)
  %call30 = call i64 @sr()
...
_10:                                              ; preds = %if.else34
  %call35 = call i64 @sp()
  %call36 = call i64 @gr(i64 1, i64 0)
  call void @sa(i64 %call36)
  %call38 = call i64 @sp()
  store i64 %call38, i64* %v037, align 8
  %call40 = call i64 @sp()
  store i64 %call40, i64* %v139, align 8
  %8 = load i64, i64* %v037, align 8
  call void @sa(i64 %8)
  %9 = load i64, i64* %v139, align 8
  call void @sa(i64 %9)
  %call41 = call i64 @sr()
...
_13:                                              ; preds = %if.then51
  %call53 = call i64 @sr()
  call void @sa(i64 %call53)
  call void @sa(i64 0)
  %call55 = call i64 @sp()
  store i64 %call55, i64* %v054, align 8
  %call57 = call i64 @sp()
  store i64 %call57, i64* %v156, align 8
  %10 = load i64, i64* %v054, align 8
  call void @sa(i64 %10)
  %11 = load i64, i64* %v156, align 8
  call void @sa(i64 %11)
  call void @sa(i64 2)
  %call59 = call i64 @sp()
  store i64 %call59, i64* %v058, align 8
  %call61 = call i64 @sp()
  store i64 %call61, i64* %v160, align 8
  %12 = load i64, i64* %v160, align 8
  %13 = load i64, i64* %v058, align 8
  %call62 = call i64 @sp()
  call void @gw(i64 %12, i64 %13, i64 %call62)
  %call63 = call i64 @sp()
  %sub64 = sub nsw i64 %call63, 1
  call void @sa(i64 %sub64)
  %call65 = call i64 @sr()
  call void @sa(i64 %call65)
  br label %_12

_14:                                              ; preds = %if.else52
  %call66 = call i64 @sp()
  %call67 = call i64 @sr()
  call void @sa(i64 %call67)
  br label %_15

_15:                                              ; preds = %if.then101, %_14
  %call68 = call i64 @sr()
  %rem69 = srem i64 %call68, 10
  call void @sa(i64 %rem69)
  %call70 = call i64 @sr()
  call void @sa(i64 %call70)
  %call71 = call i64 @sp()
...
_16:                                              ; preds = %if.then74
  ...
  call void @sa(i64 2)
  %call78 = call i64 @sp()
  store i64 %call78, i64* %v077, align 8
  %call79 = call i64 @sp()
  %14 = load i64, i64* %v077, align 8
  %call80 = call i64 @gr(i64 %call79, i64 %14)
  call void @sa(i64 %call80)
  %call81 = call i64 @sp()
...
_17:                                              ; preds = %if.else85
  call void @sa(i64 1)
  %call87 = call i64 @sp()
  store i64 %call87, i64* %v086, align 8
  %call89 = call i64 @sp()
  store i64 %call89, i64* %v188, align 8
  %15 = load i64, i64* %v086, align 8
  call void @sa(i64 %15)
  %16 = load i64, i64* %v188, align 8
  call void @sa(i64 %16)
  call void @sa(i64 2)
  %call91 = call i64 @sp()
  store i64 %call91, i64* %v090, align 8
  %call93 = call i64 @sp()
  store i64 %call93, i64* %v192, align 8
  %17 = load i64, i64* %v192, align 8
  %18 = load i64, i64* %v090, align 8
  %call94 = call i64 @sp()
  call void @gw(i64 %17, i64 %18, i64 %call94)
  %call95 = call i64 @sp()
  %div96 = sdiv i64 %call95, 10
  call void @sa(i64 %div96)
  %call97 = call i64 @sr()
  call void @sa(i64 %call97)
  %call98 = call i64 @sp()
...
_20:                                              ; preds = %if.then107
  %call109 = call i64 @sr()
  call void @sa(i64 %call109)
  call void @sa(i64 2)
  %call111 = call i64 @sp()
  store i64 %call111, i64* %v0110, align 8
  %call112 = call i64 @sp()
  %19 = load i64, i64* %v0110, align 8
  %call113 = call i64 @gr(i64 %call112, i64 %19)
  call void @sa(i64 %call113)
  %call115 = call i64 @sp()
  store i64 %call115, i64* %v0114, align 8
  %call117 = call i64 @sp()
  store i64 %call117, i64* %v1116, align 8
  %20 = load i64, i64* %v0114, align 8
  call void @sa(i64 %20)
  %21 = load i64, i64* %v1116, align 8
  call void @sa(i64 %21)
  %call118 = call i64 @sp()
  %sub119 = sub nsw i64 %call118, 1
  call void @sa(i64 %sub119)
  %call120 = call i64 @sr()
...
_22:                                              ; preds = %_28, %_21
  ...
  %23 = load i64, i64* %v0152, align 8
  call void @sa(i64 %23)
  %24 = load i64, i64* %v1154, align 8
  call void @sa(i64 %24)
  %call156 = call i64 @sp()
  %call157 = call i64 @sp()
...
_23:                                              ; preds = %if.else161
  %call162 = call i64 @sp()
  %call163 = call i64 @gr(i64 4, i64 1)
  %sub164 = sub nsw i64 %call163, 2
  call void @sa(i64 %sub164)
  %call165 = call i64 @gr(i64 4, i64 1)
  %sub166 = sub nsw i64 %call165, 1
  call void @gw(i64 4, i64 1, i64 %sub166)
  %call167 = call i64 @sp()
...
_24:                                              ; preds = %if.else171
  %call172 = call i64 @gr(i64 3, i64 1)
  %sub173 = sub nsw i64 %call172, 1
  call void @sa(i64 %sub173)
  %call174 = call i64 @gr(i64 3, i64 1)
  %sub175 = sub nsw i64 %call174, 1
  call void @gw(i64 3, i64 1, i64 %sub175)
  %call176 = call i64 @sp()
...
_25:                                              ; preds = %if.else180
  %call181 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0))
  store i32 0, i32* %retval, align 4
  br label %return

_26:                                              ; preds = %if.then179
  call void @gw(i64 4, i64 1, i64 5)
  br label %_1

_27:                                              ; preds = %if.then160
  %call182 = call i64 @sp()
  %call183 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0), i64 %call182)
  store i32 0, i32* %retval, align 4
  br label %return
...
_29:                                              ; preds = %if.then
  ...
  call void @sa(i64 %add187)
  %call188 = call i64 @sr()
  %call189 = call i64 @gr(i64 3, i64 1)
  %mul190 = mul nsw i64 %call188, %call189
  call void @sa(i64 %mul190)
  %call192 = call i64 @sp()
  store i64 %call192, i64* %v0191, align 8
  %call194 = call i64 @sp()
  store i64 %call194, i64* %v1193, align 8
  %25 = load i64, i64* %v0191, align 8
  call void @sa(i64 %25)
  %26 = load i64, i64* %v1193, align 8
  call void @sa(i64 %26)
  %call195 = call i64 @sr()
  %call196 = call i64 @gr(i64 4, i64 1)
  %sub197 = sub nsw i64 %call195, %call196
  call void @sa(i64 %sub197)
  br label %_2
