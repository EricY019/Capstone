...
entry:
  ...
  store i64 2, i64* %first, align 8
  store i64 1, i64* %second, align 8
  %0 = load i64, i64* %first, align 8
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i64 %0)
  %1 = load i64, i64* %second, align 8
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64 %1)
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load i64, i64* %second, align 8
  %add = add i64 %3, %4
  store i64 %add, i64* %third, align 8
  %5 = load i64, i64* %third, align 8
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), i64 %5)
  %6 = load i64, i64* %second, align 8
  store i64 %6, i64* %first, align 8
  %7 = load i64, i64* %third, align 8
  store i64 %7, i64* %second, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([180 x i8], [180 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
