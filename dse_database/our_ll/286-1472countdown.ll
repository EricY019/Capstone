...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %1)
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call1 = call i32 @fflush(%struct._IO_FILE* %2)
  %call2 = call i32 @sleep(i64 1000)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0))
  %call4 = call i64 @clock() #3
  store i64 %call4, i64* %c, align 8
  %4 = load i64, i64* %c, align 8
  %conv = sitofp i64 %4 to double
  %div = fdiv double %conv, 1.000000e+06
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i64 0, i64 0), double %div)
  ret i32 0
}
