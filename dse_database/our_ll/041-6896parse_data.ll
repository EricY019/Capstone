; ModuleID = 'code/041-6896parse_data.c'
source_filename = "code/041-6896parse_data.c"
...
define dso_local void @dump_data(i8* %data, i32 %bytes) #0 {
entry:
...
entry:
  ...
  store float 5.000000e+00, float* %d, align 4
  %0 = bitcast float* %d to i8*
  call void @dump_data(i8* %0, i32 4)
  ret i32 0
}
