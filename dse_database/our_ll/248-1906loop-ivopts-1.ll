...
entry:
  ...
  %arraydecay = getelementptr inbounds [4 x float], [4 x float]* %x, i64 0, i64 0
  call void @foo(float* %arraydecay)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @foo(float* %x) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* @foo.t16, i64 0, i64 %idxprom
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* @foo.t16, i64 0, i64 %idxprom6
  %8 = load float, float* %arrayidx7, align 4
  %9 = load float, float* %temp, align 4
  %mul8 = fmul float %8, %9
  %10 = load i32, i32* %k, align 4
  %idxprom9 = sext i32 %10 to i64
  %arrayidx10 = getelementptr inbounds [4 x float], [4 x float]* @foo.tmp, i64 0, i64 %idxprom9
...
for.end13:                                        ; preds = %for.cond
  %13 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i64 0, i64 0), align 16
  ...
  %15 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i64 0, i64 1), align 4
  %16 = load float*, float** %x.addr, align 8
  %arrayidx15 = getelementptr inbounds float, float* %16, i64 1
  store float %15, float* %arrayidx15, align 4
  %17 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i64 0, i64 2), align 8
  %18 = load float*, float** %x.addr, align 8
  %arrayidx16 = getelementptr inbounds float, float* %18, i64 2
  store float %17, float* %arrayidx16, align 4
  %19 = load float, float* getelementptr inbounds ([4 x float], [4 x float]* @foo.tmp, i64 0, i64 3), align 4
  %20 = load float*, float** %x.addr, align 8
  %arrayidx17 = getelementptr inbounds float, float* %20, i64 3
