...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load double, double* %acc, align 8
  %add2 = fadd double %6, %div
  store double %add2, double* %acc, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %8 = load i64, i64* %clock_start, align 8
  %sub = sub nsw i64 %call3, %8
  %div4 = sdiv i64 %sub, 1000
  %conv5 = trunc i64 %div4 to i32
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i32 %conv5)
  %9 = load double, double* %acc, align 8
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i64 0, i64 0), double %9)
  ret i32 0
}
