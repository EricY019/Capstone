...
define dso_local i32 @prime(i32 %n) #0 {
entry:
...
entry:
  ...
  store i32 2000000, i32* %max, align 4
  store i32 3, i32* %i, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i64 %6)
  %7 = load i32, i32* %retval, align 4
  ret i32 %7
}
