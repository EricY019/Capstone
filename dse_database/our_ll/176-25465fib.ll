; ModuleID = 'code/176-25465fib.c'
source_filename = "code/176-25465fib.c"
...
entry:
  ...
  store double -1.000000e+00, double* %prev, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = load double, double* %prev, align 8
  %add = fadd double %2, %3
  store double %add, double* %sum, align 8
  %4 = load double, double* %result, align 8
  store double %4, double* %prev, align 8
