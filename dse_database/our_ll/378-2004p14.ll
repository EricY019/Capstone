...
entry:
  ...
  store i32 1, i32* %this_terms, align 4
...
while.body:                                       ; preds = %while.cond
  %3 = load i32, i32* %this_terms, align 4
  %inc = add nsw i32 %3, 1
  store i32 %inc, i32* %this_terms, align 4
...
while.end:                                        ; preds = %while.cond
  %7 = load i32, i32* %this_terms, align 4
  %8 = load i32, i32* %terms, align 4
  %cmp5 = icmp sgt i32 %7, %8
  br i1 %cmp5, label %if.then, label %if.end

if.then:                                          ; preds = %while.end
  %9 = load i32, i32* %this_terms, align 4
  store i32 %9, i32* %terms, align 4
  %10 = load i32, i32* %i, align 4
  store i32 %10, i32* %longest, align 4
  br label %if.end
