...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 %2)
...
entry:
  ...
  %call = call noalias align 16 i8* @malloc(i64 320) #3
  %0 = bitcast i8* %call to i64*
  store i64* %0, i64** %hebra1, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @pthread_create(i64* %arrayidx, %union.pthread_attr_t* null, i8* (i8*)* @procedimiento, i8* %6) #3
  br label %for.inc
...
for.end11:                                        ; preds = %for.cond2
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.1, i64 0, i64 0))
