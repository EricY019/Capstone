; ModuleID = 'code/216-3644Puzzle.c'
source_filename = "code/216-3644Puzzle.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Fit(i32 %i, i32 %j) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Place(i32 %i, i32 %j) #0 {
entry:
  %retval = alloca i32, align 4
  %i.addr = alloca i32, align 4
  %j.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @Remove(i32 %i, i32 %j) #0 {
entry:
  %i.addr = alloca i32, align 4
  %j.addr = alloca i32, align 4
  %k = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @Trial(i32 %j) #0 {
entry:
  %retval = alloca i32, align 4
  %j.addr = alloca i32, align 4
...
if.end362:                                        ; preds = %if.end361, %if.then355
  ...
  %call363 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %139)
  %140 = load i32, i32* @kount, align 4
  %call364 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i64 0, i64 0), i32 %140)
  ret void
}
