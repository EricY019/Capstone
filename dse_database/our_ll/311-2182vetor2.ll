; ModuleID = 'code/311-2182vetor2.c'
source_filename = "code/311-2182vetor2.c"
...
entry:
  ...
  %arrayidx = getelementptr inbounds [10 x i32], [10 x i32]* %v, i64 0, i64 5
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx1 = getelementptr inbounds [10 x i32], [10 x i32]* %v, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  ...
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %10)
  ret i32 0
}
