...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 70, i32 67)
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i64 0, i64 0), i32 %1, double %mul)
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %3 = load i32, i32* %fahr, align 4
  %sub2 = sub nsw i32 %3, 20
  store i32 %sub2, i32* %fahr, align 4
