...
@.str.1 = private unnamed_addr constant [23 x i8] c"code/083-5307ashlti3.c\00", align 1
@__PRETTY_FUNCTION__.run = private unnamed_addr constant [28 x i8] c"void run(unsigned __int128)\00", align 1
...
for.body3:                                        ; preds = %for.cond2
  ...
  store i128 %9, i128* %coerce4, align 16
  %10 = bitcast i128* %coerce4 to { i64, i64 }*
  %11 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %10, i32 0, i32 0
  %12 = load i64, i64* %11, align 16
  %13 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %10, i32 0, i32 1
  %14 = load i64, i64* %13, align 8
  call void @run(i64 %12, i64 %14)
  br label %for.inc5

for.inc5:                                         ; preds = %for.body3
  %15 = load i128, i128* %x1, align 16
  %mul6 = mul i128 %15, 3
...
for.body:                                         ; preds = %for.cond
  ...
  %shl = shl i128 %5, %sh_prom
  %7 = load i128, i128* %y, align 16
  %cmp2 = icmp eq i128 %shl, %7
...
cond.false:                                       ; preds = %for.body
  call void @__assert_fail(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i32 8, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__PRETTY_FUNCTION__.run, i64 0, i64 0)) #2
  unreachable
...
cond.end:                                         ; preds = %8, %cond.true
  ...
  %shl3 = shl i128 %9, 1
  store i128 %shl3, i128* %y, align 16
  br label %for.inc
