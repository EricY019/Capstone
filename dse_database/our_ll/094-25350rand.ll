; ModuleID = 'code/094-25350rand.c'
source_filename = "code/094-25350rand.c"
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %1)
