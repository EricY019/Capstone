; ModuleID = 'code/316-2342ex12.c'
source_filename = "code/316-2342ex12.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@.str = private unnamed_addr constant [39 x i8] c"You have only one argument. You suck.\0A\00", align 1
...
if.then3:                                         ; preds = %land.lhs.true
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i64 0, i64 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i8* %7)
  br label %for.inc
...
if.else8:                                         ; preds = %land.lhs.true, %if.else
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i64 0, i64 0))
  br label %if.end
