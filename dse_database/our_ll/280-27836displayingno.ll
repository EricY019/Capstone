; ModuleID = 'code/280-27836displayingno.c'
source_filename = "code/280-27836displayingno.c"
...
while.body:                                       ; preds = %while.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i32 %2)
