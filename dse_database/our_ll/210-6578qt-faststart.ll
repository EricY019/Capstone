...
@.str.3 = private unnamed_addr constant [44 x i8] c"could not allocate %lu bytes for ftyp atom\0A\00", align 1
...
@.str.7 = private unnamed_addr constant [44 x i8] c"could not allocate %lu bytes for moov atom\0A\00", align 1
...
if.then57:                                        ; preds = %if.then54
  ...
  %call58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i64 0, i64 0), i64 %26)
  br label %error_out
...
if.then174:                                       ; preds = %if.end168
  ...
  %call175 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.7, i64 0, i64 0), i64 %76)
  br label %error_out
