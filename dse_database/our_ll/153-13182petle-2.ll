; ModuleID = 'code/153-13182petle-2.c'
source_filename = "code/153-13182petle-2.c"
...
if.else:                                          ; preds = %while.body
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i64 0, i64 0))
  br label %if.end
