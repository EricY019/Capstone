; ModuleID = 'code/363-26435hilos_exit.c'
source_filename = "code/363-26435hilos_exit.c"
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 @pthread_create(i64* %arrayidx, %union.pthread_attr_t* null, i8* (i8*)* @trabajo, i8* null) #5
...
while.end:                                        ; preds = %while.cond
  ...
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i64 0, i64 0), i32 %5)
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @pthread_equal(i64 %2, i64 %3) #7
  %tobool = icmp ne i32 %call1, 0
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %4 = load i32, i32* @variable_global, align 4
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.3, i64 0, i64 0), i32 %4)
  br label %if.end

if.else:                                          ; preds = %for.body
  %5 = load i32, i32* @variable_global, align 4
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.4, i64 0, i64 0), i32 %5)
  br label %if.end
...
declare dso_local i64 @pthread_self() #4

; Function Attrs: nounwind readnone willreturn
declare dso_local i32 @pthread_equal(i64, i64) #4
