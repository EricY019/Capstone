...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load i64, i64* %f2, align 8
  store i64 %2, i64* %f1, align 8
  %3 = load i64, i64* %t, align 8
  %4 = load i64, i64* %f2, align 8
  %add = add nsw i64 %3, %4
  store i64 %add, i64* %f2, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %7 = load i64, i64* %f2, align 8
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i64 %6, i64 %7)
  ret i32 0
}
