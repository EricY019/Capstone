; ModuleID = 'code/350-1694arodriguez154.c'
source_filename = "code/350-1694arodriguez154.c"
...
entry:
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i64 0, i64 0), i32 65)
