; ModuleID = 'code/192-19955show_bytes.c'
source_filename = "code/192-19955show_bytes.c"
...
entry:
  ...
  store i32 -2023406815, i32* %val, align 4
  %0 = bitcast i32* %val to i8*
  store i8* %0, i8** %valp, align 8
  %1 = load i8*, i8** %valp, align 8
  call void @show_bytes(i8* %1, i32 1)
  %2 = load i8*, i8** %valp, align 8
  call void @show_bytes(i8* %2, i32 2)
  %3 = load i8*, i8** %valp, align 8
  call void @show_bytes(i8* %3, i32 3)
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0), i8** %s, align 8
  %4 = load i8*, i8** %s, align 8
  %5 = load i8*, i8** %s, align 8
  %call = call i64 @strlen(i8* %5) #3
  %conv = trunc i64 %call to i32
  call void @show_bytes(i8* %4, i32 %conv)
  ret i32 0
}
