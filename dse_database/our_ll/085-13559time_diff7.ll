...
for.body4:                                        ; preds = %for.cond2
  %call5 = call i32 @system(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0))
  br label %for.inc
...
for.end8:                                         ; preds = %for.cond
  %call9 = call i64 @clock() #3
  store i64 %call9, i64* %finish, align 8
  ...
  %mul = mul nsw i64 %6, %7
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0), i64 %mul)
  %8 = load double, double* %duration, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.2, i64 0, i64 0), double %8)
  ret i32 0
}
