...
entry:
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i64 0, i64 0))
  store i8 33, i8* %num, align 1
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %1 = load i8, i8* %num, align 1
  %conv4 = sext i8 %1 to i32
  %2 = load i8, i8* %num, align 1
  %conv5 = sext i8 %2 to i32
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0), i32 %conv4, i32 %conv5)
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %3 = load i8, i8* %num, align 1
  %inc = add i8 %3, 1
  store i8 %inc, i8* %num, align 1
