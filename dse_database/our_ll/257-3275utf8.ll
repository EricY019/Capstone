...
for.body3:                                        ; preds = %for.cond1
  ...
  %add = add nsw i32 %3, %4
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %add)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond1
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %for.inc6
...
for.body11:                                       ; preds = %for.cond9
  ...
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %8)
  store i32 0, i32* %j, align 4
  br label %for.cond13
...
for.body15:                                       ; preds = %for.cond13
  ...
  store i32 %add17, i32* %b0, align 4
  ...
  %call20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i64 0, i64 0), i32 %14, i32 %15)
  br label %for.inc21
...
for.end23:                                        ; preds = %for.cond13
  %call24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %for.inc25
...
if.end42:                                         ; preds = %land.lhs.true39, %if.end37
  ...
  %call43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %25)
  store i32 0, i32* %j, align 4
  br label %for.cond44
...
for.body46:                                       ; preds = %for.cond44
  ...
  store i32 %add48, i32* %sum47, align 4
  %29 = load i32, i32* %sum47, align 4
  %and50 = and i32 %29, 63
  %add51 = add nsw i32 128, %and50
  store i32 %add51, i32* %b049, align 4
  %30 = load i32, i32* %sum47, align 4
  %and53 = and i32 %30, 4032
  %shr54 = ashr i32 %and53, 6
  %add55 = add nsw i32 128, %shr54
  store i32 %add55, i32* %b152, align 4
  %31 = load i32, i32* %sum47, align 4
  %and56 = and i32 %31, 61440
  %shr57 = ashr i32 %and56, 12
  %add58 = add nsw i32 224, %shr57
  store i32 %add58, i32* %b2, align 4
  %32 = load i32, i32* %b2, align 4
  %33 = load i32, i32* %b152, align 4
  %34 = load i32, i32* %b049, align 4
  %call59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i64 0, i64 0), i32 %32, i32 %33, i32 %34)
  br label %for.inc60
...
for.end62:                                        ; preds = %for.cond44
  %call63 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0))
  br label %for.inc64

for.inc64:                                        ; preds = %for.end62, %if.then41, %if.then36, %if.then
  %36 = load i32, i32* %k, align 4
  %add65 = add nsw i32 %36, 16
  store i32 %add65, i32* %k, align 4
