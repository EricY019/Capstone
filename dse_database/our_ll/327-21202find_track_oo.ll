; ModuleID = 'code/327-21202find_track_oo.c'
source_filename = "code/327-21202find_track_oo.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.Regex = type { [1 x %struct.re_pattern_buffer] }
...
define dso_local %struct.Regex* @make_regex(i8* %pattern, i32 %flags) #0 {
entry:
  %pattern.addr = alloca i8*, align 8
  %flags.addr = alloca i32, align 4
  store i8* %pattern, i8** %pattern.addr, align 8
  store i32 %flags, i32* %flags.addr, align 4
  ret %struct.Regex* null
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @regex_match(%struct.Regex* %regex, i8* %s) #0 {
entry:
  %regex.addr = alloca %struct.Regex*, align 8
  %s.addr = alloca i8*, align 8
  store %struct.Regex* %regex, %struct.Regex** %regex.addr, align 8
  store i8* %s, i8** %s.addr, align 8
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @regex_free(%struct.Regex* %regex) #0 {
entry:
  %regex.addr = alloca %struct.Regex*, align 8
  store %struct.Regex* %regex, %struct.Regex** %regex.addr, align 8
  ret void
...
entry:
  ...
  %regex = alloca %struct.Regex*, align 8
  store i8* %pattern, i8** %pattern.addr, align 8
  %0 = load i8*, i8** %pattern.addr, align 8
  %call = call %struct.Regex* @make_regex(i8* %0, i32 9)
  store %struct.Regex* %call, %struct.Regex** %regex, align 8
...
for.body:                                         ; preds = %for.cond
  %2 = load %struct.Regex*, %struct.Regex** %regex, align 8
  ...
  %call1 = call i32 @regex_match(%struct.Regex* %2, i8* %arraydecay)
...
for.end:                                          ; preds = %for.cond
  %7 = load %struct.Regex*, %struct.Regex** %regex, align 8
  call void @regex_free(%struct.Regex* %7)
  ret void
}
