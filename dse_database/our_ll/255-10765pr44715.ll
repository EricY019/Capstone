...
define dso_local void @foo(i32 %x, i32 %y) #0 {
entry:
...
if.end17:                                         ; preds = %for.cond14
  store i32 5, i32* %tmp18, align 4
  %11 = load i32, i32* %tmp18, align 4
...
if.end31:                                         ; preds = %for.inc28
  store i32 1, i32* %tmp32, align 4
  %15 = load i32, i32* %tmp32, align 4
...
if.end37:                                         ; preds = %sw.bb34
  store i32 1, i32* %tmp38, align 4
  %18 = load i32, i32* %tmp38, align 4
...
if.end11:                                         ; preds = %do.cond
  ...
  br i1 %tobool13, label %do.body, label %do.end, !llvm.loop !11
...
if.end28:                                         ; preds = %for.cond25
  store i32 5, i32* %tmp29, align 4
  %15 = load i32, i32* %tmp29, align 4
...
if.end44:                                         ; preds = %for.inc41
  store i32 1, i32* %tmp45, align 4
  %20 = load i32, i32* %tmp45, align 4
...
if.end52:                                         ; preds = %if.then49
  store i32 1, i32* %tmp53, align 4
  %24 = load i32, i32* %tmp53, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @baz(i32 %x, i32 %y) #0 {
entry:
  %x.addr = alloca i32, align 4
  %y.addr = alloca i32, align 4
  %z = alloca i32, align 4
...
if.end14:                                         ; preds = %do.cond
  ...
  %7 = load i32, i32* %tmp15, align 4
  %tobool16 = icmp ne i32 %7, 0
  br i1 %tobool16, label %do.body, label %do.end, !llvm.loop !17
...
if.end32:                                         ; preds = %for.cond29
  store i32 5, i32* %tmp33, align 4
  %16 = load i32, i32* %tmp33, align 4
...
if.end48:                                         ; preds = %for.inc45
  store i32 1, i32* %tmp49, align 4
  %21 = load i32, i32* %tmp49, align 4
...
if.end56:                                         ; preds = %if.then53
  store i32 1, i32* %tmp57, align 4
  %25 = load i32, i32* %tmp57, align 4
...
entry:
  ...
  call void @foo(i32 2, i32 1)
  call void @foo(i32 3, i32 1)
  call void @foo(i32 4, i32 1)
  call void @foo(i32 5, i32 1)
  call void @bar(i32 0, i32 1)
  call void @bar(i32 1, i32 1)
  call void @bar(i32 2, i32 1)
  call void @bar(i32 3, i32 1)
  call void @bar(i32 4, i32 1)
  call void @bar(i32 5, i32 1)
  call void @baz(i32 0, i32 0)
  call void @baz(i32 1, i32 0)
  call void @baz(i32 2, i32 0)
  call void @baz(i32 3, i32 0)
  call void @baz(i32 4, i32 0)
  call void @baz(i32 5, i32 0)
  ret i32 0
}
