...
for.body:                                         ; preds = %for.cond
  ...
  %call3 = call i64 @strtol(i8* %7, i8** null, i32 0) #3
  store i64 %call3, i64* %x, align 8
  %8 = load i64, i64* %x, align 8
  %call4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i64 0, i64 0), i64 %8)
  %9 = load i64, i64* %x, align 8
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0), i64 %9)
  %10 = load i64, i64* %x, align 8
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i64 0, i64 0), i64 %10)
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0))
  br label %for.inc
