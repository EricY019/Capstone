...
entry:
  ...
  %add = add i64 %conv, 4
  %call = call noalias align 16 i8* @malloc(i64 %add) #4
...
for.body:                                         ; preds = %for.cond
  ...
  call void @llvm.memset.p0i8.i64(i8* align 4 %7, i8 -1, i64 %add4, i1 false)
...
for.end41:                                        ; preds = %for.cond5
  ...
  %call42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i64 0, i64 0), i32 %31, i32 %32)
  br label %for.inc43
