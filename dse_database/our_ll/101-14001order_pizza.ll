; ModuleID = 'code/101-14001order_pizza.c'
source_filename = "code/101-14001order_pizza.c"
...
sw.default:                                       ; preds = %while.body
  ...
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i64 0, i64 0), i8* %5)
...
if.then:                                          ; preds = %while.end
  %call6 = call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0))
  br label %if.end
...
if.then8:                                         ; preds = %if.end
  ...
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0), i8* %13)
  br label %if.end10

if.end10:                                         ; preds = %if.then8, %if.end
  %call11 = call i32 @puts(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.5, i64 0, i64 0))
  store i32 0, i32* %count, align 4
  br label %for.cond
