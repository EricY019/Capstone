; ModuleID = 'code/367-1888show_byte.c'
source_filename = "code/367-1888show_byte.c"
...
define dso_local void @show_bytes(i8* %start, i32 %length) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i32 %conv)
  br label %for.inc
