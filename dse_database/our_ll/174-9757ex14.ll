...
define dso_local i32 @soma(i32 %x, i32 %y) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @print_letters(i8* %arg) #0 {
entry:
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %call = call i64 @strlen(i8* %arrayidx) #4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds i8, i8* %2, i64 %idxprom1
  ...
  %arrayidx5 = getelementptr inbounds i16, i16* %5, i64 %idxprom4
...
lor.lhs.false:                                    ; preds = %for.body
  %call8 = call i16** @__ctype_b_loc() #5
  %8 = load i16*, i16** %call8, align 8
...
if.then:                                          ; preds = %lor.lhs.false, %for.body
  ...
  %call17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %conv15, i32 %conv16)
  br label %if.end
...
entry:
  ...
  %call = call i32 @soma(i32 1, i32 2)
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %call)
  ret i32 0
}
