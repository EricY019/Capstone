...
for.body:                                         ; preds = %for.cond
  ...
  %2 = load double, double* getelementptr inbounds ([236 x double], [236 x double]* @int_to_float_table, i64 0, i64 40), align 16
  %3 = load double, double* %value, align 8
  %sub = fsub double %2, %3
  %4 = call double @llvm.fabs.f64(double %sub)
  store double %4, double* %minerr, align 8
  store i32 40, i32* %best, align 4
...
for.body5:                                        ; preds = %for.cond2
  ...
  %arrayidx = getelementptr inbounds [236 x double], [236 x double]* @int_to_float_table, i64 0, i64 %idxprom
  %7 = load double, double* %arrayidx, align 8
  %8 = load double, double* %value, align 8
  %sub6 = fsub double %7, %8
  %9 = call double @llvm.fabs.f64(double %sub6)
  store double %9, double* %err, align 8
  %10 = load double, double* %err, align 8
  %11 = load double, double* %minerr, align 8
  %cmp7 = fcmp olt double %10, %11
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %for.body5
  %12 = load double, double* %err, align 8
  store double %12, double* %minerr, align 8
...
for.end:                                          ; preds = %for.cond2
  ...
  %cond = select i1 %cmp9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.4, i64 0, i64 0)
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 %15, i32 %16, i8* %cond)
  br label %for.inc12
...
for.end14:                                        ; preds = %for.cond
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0))
  ret i32 0
}
