; ModuleID = 'code/169-30018py-prettyprint.c'
source_filename = "code/169-30018py-prettyprint.c"
...
@an_int = dso_local global i32 -1, align 4
@an_int_type = dso_local global i32 1, align 4
@an_int_type2 = dso_local global i32 2, align 4
...
@.str.10 = private unnamed_addr constant [10 x i8] c"bug_14741\00", align 1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @set_item(%struct.container* %c, i32 %i, i32 %val) #0 {
entry:
  %c.addr = alloca %struct.container*, align 8
  ...
  %1 = load %struct.container*, %struct.container** %c.addr, align 8
  %len = getelementptr inbounds %struct.container, %struct.container* %1, i32 0, i32 1
...
if.then:                                          ; preds = %entry
  %3 = load i32, i32* %val.addr, align 4
  %4 = load %struct.container*, %struct.container** %c.addr, align 8
  %elements = getelementptr inbounds %struct.container, %struct.container* %4, i32 0, i32 2
  %5 = load i32*, i32** %elements, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @eval_func(i32 %p1, i32 %p2, i32 %p3, i32 %p4, i32 %p5, i32 %p6, i32 %p7, i32 %p8) #0 {
entry:
  ...
  %p6.addr = alloca i32, align 4
  %p7.addr = alloca i32, align 4
  %p8.addr = alloca i32, align 4
  ...
  store i32 %p5, i32* %p5.addr, align 4
  store i32 %p6, i32* %p6.addr, align 4
  store i32 %p7, i32* %p7.addr, align 4
  store i32 %p8, i32* %p8.addr, align 4
...
entry:
  ...
  %estring3 = alloca %struct.lazystring, align 8
  ...
  %len9 = getelementptr inbounds %struct.lazystring, %struct.lazystring* %estring, i32 0, i32 1
  store i32 -1, i32* %len9, align 8
  %lazy_str10 = getelementptr inbounds %struct.lazystring, %struct.lazystring* %estring2, i32 0, i32 0
  store i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.9, i64 0, i64 0), i8** %lazy_str10, align 8
  %len11 = getelementptr inbounds %struct.lazystring, %struct.lazystring* %estring2, i32 0, i32 1
  store i32 -1, i32* %len11, align 8
  %lazy_str12 = getelementptr inbounds %struct.lazystring, %struct.lazystring* %estring3, i32 0, i32 0
  store i8* null, i8** %lazy_str12, align 8
  %len13 = getelementptr inbounds %struct.lazystring, %struct.lazystring* %estring3, i32 0, i32 1
  store i32 42, i32* %len13, align 8
  call void @add_item(%struct.container* %c, i32 23)
  call void @add_item(%struct.container* %c, i32 72)
  %elements14 = getelementptr inbounds %struct.justchildren, %struct.justchildren* %nstype, i32 0, i32 1
  %2 = load i32*, i32** %elements14, align 8
  %arrayidx15 = getelementptr inbounds i32, i32* %2, i64 0
  store i32 7, i32* %arrayidx15, align 4
  %elements16 = getelementptr inbounds %struct.justchildren, %struct.justchildren* %nstype, i32 0, i32 1
  %3 = load i32*, i32** %elements16, align 8
  %arrayidx17 = getelementptr inbounds i32, i32* %3, i64 1
  store i32 42, i32* %arrayidx17, align 4
  %len18 = getelementptr inbounds %struct.justchildren, %struct.justchildren* %nstype, i32 0, i32 0
  store i32 2, i32* %len18, align 8
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @bug_14741() #0 {
entry:
  %c = alloca %struct.container, align 8
  call void @make_container(%struct.container* sret(%struct.container) align 8 %c, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.10, i64 0, i64 0))
  call void @add_item(%struct.container* %c, i32 71)
  call void @set_item(%struct.container* %c, i32 0, i32 42)
  call void @set_item(%struct.container* %c, i32 0, i32 5)
  ret void
}
