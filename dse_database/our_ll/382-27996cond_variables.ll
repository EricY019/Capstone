...
@shared_data = dso_local global i64 123456789, align 8
...
@is_zero = dso_local global %union.pthread_cond_t zeroinitializer, align 8
...
define dso_local i8* @decrement(i8* %arg) #0 {
entry:
...
while.cond:                                       ; preds = %while.body, %entry
  %0 = load i64, i64* @shared_data, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %dec = add nsw i64 %1, -1
  store i64 %dec, i64* @shared_data, align 8
  %call1 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @lock) #3
  br label %while.cond, !llvm.loop !4

while.end:                                        ; preds = %while.cond
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i64 0, i64 0))
  %call3 = call i32 @pthread_cond_signal(%union.pthread_cond_t* @is_zero) #3
  ret i8* null
}
...
entry:
  ...
  %decrement_thread = alloca i64, align 8
  ...
  %call1 = call i32 @pthread_cond_init(%union.pthread_cond_t* @is_zero, %union.pthread_condattr_t* null) #3
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i64 0, i64 0))
  %call3 = call i32 @pthread_create(i64* %decrement_thread, %union.pthread_attr_t* null, i8* (i8*)* @decrement, i8* null) #3
  %call4 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* @lock) #3
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  %call5 = call i32 @pthread_cond_wait(%union.pthread_cond_t* @is_zero, %union.pthread_mutex_t* @lock)
  br label %while.cond, !llvm.loop !6

while.end:                                        ; preds = %while.cond
  %call6 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* @lock) #3
  %call7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0))
  %1 = load i64, i64* %decrement_thread, align 8
  %call8 = call i32 @pthread_join(i64 %1, i8** %exit_status)
  %call9 = call i32 @pthread_mutex_destroy(%union.pthread_mutex_t* @lock) #3
  %call10 = call i32 @pthread_cond_destroy(%union.pthread_cond_t* @is_zero) #3
  ret i32 0
}
