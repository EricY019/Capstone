...
while.body:                                       ; preds = %while.cond
  ...
  %arrayidx4 = getelementptr inbounds [65535 x i32], [65535 x i32]* %big_array, i64 0, i64 %idxprom3
  %6 = load i32, i32* %arrayidx4, align 4
  store i32 %6, i32* %at_i, align 4
...
while.body10:                                     ; preds = %land.end
  ...
  %arrayidx14 = getelementptr inbounds [65535 x i32], [65535 x i32]* %big_array, i64 0, i64 %idxprom13
...
for.body21:                                       ; preds = %for.cond19
  ...
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32 %19)
  ...
  %call25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i32 %21)
  br label %for.inc26
