; ModuleID = 'code/258-28265omp3-1-1.c'
source_filename = "code/258-28265omp3-1-1.c"
...
for.end41:                                        ; preds = %for.cond25
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %24)
  store i32 0, i32* %sum, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond42
...
for.end58:                                        ; preds = %for.cond42
  ...
  %call59 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %33)
  ret i32 0
}
