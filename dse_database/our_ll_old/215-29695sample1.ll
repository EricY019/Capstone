...
entry:
  ...
  store i32 0, ptr %colcnt, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @prime(i32 noundef %1)
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.then, label %if.end5

if.then:                                          ; preds = %for.body
  %2 = load i32, ptr %colcnt, align 4
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %colcnt, align 4
  %3 = load i32, ptr %colcnt, align 4
  %rem = srem i32 %3, 9
...
if.else:                                          ; preds = %if.then
  ...
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  br label %if.end
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @prime(i32 noundef %num) #0 {
entry:
  %retval = alloca i32, align 4
