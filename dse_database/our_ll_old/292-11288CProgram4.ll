...
define i32 @staticFn() #0 {
entry:
  %0 = load i32, ptr @staticFn.x, align 4
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @staticFn.x, align 4
  %1 = load i32, ptr @staticFn.x, align 4
  ret i32 %1
}
...
for.body12:                                       ; preds = %for.cond10
  ...
  %call14 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef %call13)
  br label %for.inc15
