; ModuleID = './code/208-10167argv.c'
source_filename = "./code/208-10167argv.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx14.0.0"

@.str = private unnamed_addr constant [8 x i8] c"%p: %s\0A\00", align 1
@__func__.main = private unnamed_addr constant [5 x i8] c"main\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"208-10167argv.c\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"!argv[argc]\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef %4, ptr noundef %7)
  br label %for.inc
...
cond.true:                                        ; preds = %for.end
  call void @__assert_rtn(ptr noundef @__func__.main, ptr noundef @.str.1, i32 noundef 9, ptr noundef @.str.2) #3
  unreachable
