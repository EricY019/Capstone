...
define void @seqSum(ptr noundef %a, ptr noundef %b, ptr noundef %c) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @fillRandomVec(ptr noundef %x) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @showVec(ptr noundef %x) #0 {
entry:
  %x.addr = alloca ptr, align 8
  %i = alloca i32, align 4
  store ptr %x, ptr %x.addr, align 8
...
entry:
  ...
  %call1 = call ptr @malloc(i64 noundef 40000000) #3
  store ptr %call1, ptr %b, align 8
  %call2 = call ptr @malloc(i64 noundef 40000000) #3
  store ptr %call2, ptr %c, align 8
  %0 = load ptr, ptr %a, align 8
  call void @fillRandomVec(ptr noundef %0)
  %1 = load ptr, ptr %b, align 8
  call void @fillRandomVec(ptr noundef %1)
  %2 = load ptr, ptr %a, align 8
  %3 = load ptr, ptr %b, align 8
  %4 = load ptr, ptr %c, align 8
  call void @seqSum(ptr noundef %2, ptr noundef %3, ptr noundef %4)
