...
entry:
  ...
  %call3 = call i32 @"\01_system"(ptr noundef @.str.3)
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call i32 @is_Multiple_of(i32 noundef %1)
...
for.end:                                          ; preds = %for.cond
  ...
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, i64 noundef %4)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @is_Multiple_of(i32 noundef %n) #0 {
entry:
  %retval = alloca i32, align 4
