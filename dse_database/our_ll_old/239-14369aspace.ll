...
entry:
  ...
  %call1 = call i32 (ptr, ...) @printf(ptr noundef @.str, ptr noundef @main)
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, ptr noundef @global)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %local)
  %0 = load ptr, ptr %p, align 8
  %call4 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, ptr noundef %0)
  ret i32 0
}
