; ModuleID = './code/340-32770cptr1.c'
source_filename = "./code/340-32770cptr1.c"
...
@.str = private unnamed_addr constant [27 x i8] c"\E5\AD\98\E5\82\A8\E5\80\BC\EF\BC\9Avar[%d] = %d \0A\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [3 x i32], ptr %var, i64 0, i64 %idxprom
  %3 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds ptr, ptr %vla, i64 %idxprom1
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx7 = getelementptr inbounds ptr, ptr %vla, i64 %idxprom6
  %8 = load ptr, ptr %arrayidx7, align 8
  %9 = load i32, ptr %8, align 4
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %6, i32 noundef %9)
  br label %for.inc8
