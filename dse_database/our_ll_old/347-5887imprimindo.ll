...
entry:
  ...
  store i8 33, ptr %lt, align 1
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i8, ptr %lt, align 1
  %conv = sext i8 %0 to i32
  %cmp = icmp sle i32 %conv, 126
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %1 = load i8, ptr %lt, align 1
  %conv4 = sext i8 %1 to i32
  %2 = load i8, ptr %lt, align 1
  %conv5 = sext i8 %2 to i32
  %call6 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %conv4, i32 noundef %conv5)
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %3 = load i8, ptr %lt, align 1
  %inc = add i8 %3, 1
  store i8 %inc, ptr %lt, align 1
