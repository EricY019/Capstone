...
@__const.main.s = private unnamed_addr constant [20 x i8] c"1234567890123456789\00", align 1
@.str = private unnamed_addr constant [4 x i8] c"%s\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define ptr @split(ptr noundef %a, i32 noundef %len, i32 noundef %deviation) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %mul = mul nsw i32 4, %1
  %call = call ptr @split(ptr noundef %arraydecay, i32 noundef 4, i32 noundef %mul)
  store ptr %call, ptr %aa, align 8
