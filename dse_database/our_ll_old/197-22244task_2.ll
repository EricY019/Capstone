...
for.body:                                         ; preds = %for.cond
  ...
  %add = add i64 %3, %4
  store i64 %add, ptr %L3, align 8
  %5 = load i64, ptr %L3, align 8
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str, i64 noundef %5)
  %6 = load i64, ptr %L2, align 8
  store i64 %6, ptr %L1, align 8
  %7 = load i64, ptr %L3, align 8
  store i64 %7, ptr %L2, align 8
  br label %for.inc
