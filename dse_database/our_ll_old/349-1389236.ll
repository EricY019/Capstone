...
@__const.main.Array = private unnamed_addr constant [10 x i32] [i32 12, i32 34, i32 56, i32 78, i32 90, i32 123, i32 456, i32 789, i32 8642, i32 9753], align 4
@.str = private unnamed_addr constant [8 x i8] c"%d: %d\0A\00", align 1
@__const.main.Array2 = private unnamed_addr constant [10 x i32] [i32 12, i32 34, i32 56, i32 78, i32 90, i32 123, i32 456, i32 789, i32 8642, i32 9753], align 4
...
entry:
  ...
  %Array2 = alloca [10 x i32], align 4
...
for.end:                                          ; preds = %for.cond
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %Array2, ptr align 4 @__const.main.Array2, i64 40, i1 false)
  store i32 0, ptr %Count, align 4
  br label %for.cond1
