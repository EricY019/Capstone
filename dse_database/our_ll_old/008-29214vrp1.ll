; ModuleID = './code/008-29214vrp1.c'
source_filename = "./code/008-29214vrp1.c"
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @bar(i32 noundef %j) #0 {
entry:
  %retval = alloca i32, align 4
...
if.then:                                          ; preds = %entry
  ...
  %add = add nsw i32 %1, 2
  %call = call i32 @foo(i32 noundef %add)
...
if.then2:                                         ; preds = %if.else
  ...
  %call4 = call i32 @foo(i32 noundef %add3)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @foo(i32 noundef %i) #0 {
entry:
