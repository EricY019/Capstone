; ModuleID = './code/027-2954ex13.c'
source_filename = "./code/027-2954ex13.c"
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 4, ptr %numStates, align 4
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds [4 x ptr], ptr %states, i64 0, i64 %idxprom5
  %11 = load ptr, ptr %arrayidx6, align 8
  %call7 = call i32 (ptr, ...) @printf(ptr noundef @.str.5, i32 noundef %9, ptr noundef %11)
  br label %for.inc8
