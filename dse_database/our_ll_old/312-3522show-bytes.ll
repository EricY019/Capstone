...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @test_show_bytes(i32 noundef %val) #0 {
entry:
  ...
  %1 = load i32, ptr %ival, align 4
  %conv = sitofp i32 %1 to float
  store float %conv, ptr %fval, align 4
  store ptr %val.addr, ptr %pval, align 8
  %2 = load i32, ptr %ival, align 4
  call void @show_int(i32 noundef %2)
  %3 = load float, ptr %fval, align 4
  call void @show_float(float noundef %3)
  %4 = load ptr, ptr %pval, align 8
  call void @show_pointer(ptr noundef %4)
  ret void
}
...
entry:
  ...
  call void @test_show_bytes(i32 noundef 12345)
  call void @show_bytes(ptr noundef @.str.2, i32 noundef 6)
  store ptr @.str.3, ptr %s, align 8
