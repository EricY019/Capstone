; ModuleID = './code/223-736sigPrint.c'
source_filename = "./code/223-736sigPrint.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx14.0.0"

@.str = private unnamed_addr constant [18 x i8] c"signal %d caught\0A\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"exiting\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @handler(i32 noundef %signo) #0 {
entry:
...
entry:
  ...
  %call = call ptr @signal(i32 noundef 2, ptr noundef @handler)
  %call1 = call ptr @signal(i32 noundef 1, ptr noundef @handler)
  br label %while.cond
...
if.then:                                          ; preds = %while.body
  ...
  store i32 %call3, ptr %sleepTime, align 4
  br label %if.end
