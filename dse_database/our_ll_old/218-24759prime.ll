...
entry:
  ...
  store i32 499, ptr %start, align 4
  store i32 75, ptr %needed, align 4
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %2 = load i32, ptr %needed, align 4
  %cmp = icmp sle i32 %1, %2
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %3 = load i32, ptr %i, align 4
  %call = call i32 @is_prime(i32 noundef %3)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @is_prime(i32 noundef %number) #0 {
entry:
  %retval = alloca i32, align 4
  ...
  %div = sdiv i32 %0, 2
  store i32 %div, ptr %middle, align 4
  store i32 2, ptr %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, ptr %i, align 4
  %2 = load i32, ptr %middle, align 4
  %cmp = icmp sle i32 %1, %2
  br i1 %cmp, label %for.body, label %for.end
