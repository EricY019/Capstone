...
define ptr @reverseString(ptr noundef %s) #0 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  store ptr %add.ptr1, ptr %right, align 8
...
while.body:                                       ; preds = %while.cond
  ...
  %incdec.ptr3 = getelementptr inbounds i8, ptr %14, i32 -1
  store ptr %incdec.ptr3, ptr %right, align 8
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %str, ptr align 1 @__const.main.str, i64 13, i1 false)
  %arraydecay = getelementptr inbounds [13 x i8], ptr %str, i64 0, i64 0
  %call = call ptr @reverseString(ptr noundef %arraydecay)
  store ptr %call, ptr %newstr, align 8
  %0 = load ptr, ptr %newstr, align 8
