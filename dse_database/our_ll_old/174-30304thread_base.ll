...
entry:
  ...
  %2 = load ptr, ptr %threadid.addr, align 8
...
entry:
  ...
  %threads = alloca [5 x ptr], align 8
  %ids = alloca [5 x ptr], align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x ptr], ptr %ids, i64 0, i64 %idxprom
  store ptr %call, ptr %arrayidx, align 8
  %2 = load i32, ptr %i, align 4
  %3 = load i32, ptr %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [5 x ptr], ptr %ids, i64 0, i64 %idxprom1
  %4 = load ptr, ptr %arrayidx2, align 8
  store i32 %2, ptr %4, align 4
  %5 = load i32, ptr %i, align 4
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %5)
  %6 = load i32, ptr %i, align 4
  %idxprom4 = sext i32 %6 to i64
  %arrayidx5 = getelementptr inbounds [5 x ptr], ptr %threads, i64 0, i64 %idxprom4
  %7 = load i32, ptr %i, align 4
  %idxprom6 = sext i32 %7 to i64
  %arrayidx7 = getelementptr inbounds [5 x ptr], ptr %ids, i64 0, i64 %idxprom6
  %8 = load ptr, ptr %arrayidx7, align 8
  %call8 = call i32 @pthread_create(ptr noundef %arrayidx5, ptr noundef null, ptr noundef @PrintHello, ptr noundef %8)
  br label %for.inc
