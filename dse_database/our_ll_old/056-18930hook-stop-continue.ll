...
define i32 @funbreak(i32 noundef %i) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @func(i32 noundef %i) #0 {
entry:
  %i.addr = alloca i32, align 4
  store i32 %i, ptr %i.addr, align 4
  %0 = load i32, ptr %i.addr, align 4
...
entry:
  ...
  %call = call i32 @func(i32 noundef 1)
  %call1 = call i32 @func(i32 noundef 2)
  %call2 = call i32 @func(i32 noundef 3)
  %call3 = call i32 @func(i32 noundef 4)
  %call4 = call i32 @funbreak(i32 noundef 5)
  ret i32 0
}
