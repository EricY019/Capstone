...
entry:
  ...
  call void @transparent_crc(i32 noundef %0, ptr noundef @.str, i32 noundef %1)
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %xor = xor i32 %3, -1
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str.2, ptr noundef %2, i32 noundef %xor)
  br label %if.end
...
entry:
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %0, i64 noundef %xor)
...
entry:
  ...
  call void @step_hash(i32 noundef 5)
...
for.body:                                         ; preds = %for.cond
  call void @step_hash(i32 noundef 4)
  %1 = load i32, ptr @g_2, align 4
  %conv = trunc i32 %1 to i16
  store i16 %conv, ptr %retval, align 2
  br label %return

for.inc:                                          ; No predecessors!
  %2 = load i32, ptr @g_2, align 4
  %sub = sub nsw i32 %2, 7
  store i32 %sub, ptr @g_2, align 4
  br label %for.cond, !llvm.loop !9

for.end:                                          ; preds = %for.cond
  call void @step_hash(i32 noundef 6)
  %3 = load i32, ptr @g_2, align 4
  %conv1 = sext i32 %3 to i64
  %cmp2 = icmp ne i64 4294967295, %conv1
  %conv3 = zext i1 %cmp2 to i32
  store i32 %conv3, ptr @g_2, align 4
  call void @step_hash(i32 noundef 7)
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %1)
  br label %if.end
