; ModuleID = './code/208-13024str_upper_case.c'
source_filename = "./code/208-13024str_upper_case.c"
...
@.str.2 = private unnamed_addr constant [26 x i8] c"208-13024str_upper_case.c\00", align 1
...
@.str.6 = private unnamed_addr constant [18 x i8] c"Before uppercase\0A\00", align 1
...
@.str.11 = private unnamed_addr constant [18 x i8] c"\0AAfter uppercase\0A\00", align 1
...
define ptr @str_upper_case(ptr noundef %dest, ptr noundef %src) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 @toupper(i32 noundef %conv3) #7
...
cond.end27:                                       ; preds = %cond.false26, %7
  ...
  %call34 = call ptr @str_upper_case(ptr noundef %10, ptr noundef %11)
  %12 = load ptr, ptr %dest2, align 8
  %arraydecay35 = getelementptr inbounds [6 x i8], ptr %src2, i64 0, i64 0
  %call36 = call ptr @str_upper_case(ptr noundef %12, ptr noundef %arraydecay35)
  %13 = load ptr, ptr %dest3, align 8
  %14 = load ptr, ptr %src3, align 8
  %call37 = call ptr @str_upper_case(ptr noundef %13, ptr noundef %14)
