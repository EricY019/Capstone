...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [9 x ptr], ptr %planets, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %fmt, ptr align 1 @__const.main.fmt, i64 4, i1 false)
  store i32 3, ptr %k, align 4
  %arraydecay = getelementptr inbounds [4 x i8], ptr %fmt, i64 0, i64 0
  %4 = load i32, ptr %k, align 4
  %call1 = call i32 (ptr, ...) @printf(ptr noundef %arraydecay, i32 noundef %4)
  ret i32 0
}
