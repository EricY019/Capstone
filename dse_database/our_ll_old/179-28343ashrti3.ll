...
@.str = private unnamed_addr constant [19 x i8] c"179-28343ashrti3.c\00", align 1
...
entry:
  ...
  store i128 170141183460469231731687303715884105727, ptr %max, align 16
...
for.body3:                                        ; preds = %for.cond2
  ...
  %5 = load i128, ptr %max, align 16
  %and = and i128 %4, %5
  call void @run(i128 noundef %and)
  br label %for.inc4

for.inc4:                                         ; preds = %for.body3
  %6 = load i128, ptr %x1, align 16
  %mul5 = mul i128 %6, 3
...
cond.end:                                         ; preds = %cond.false, %5
  ...
  %shr2 = ashr i128 %6, 1
  store i128 %shr2, ptr %y, align 16
  br label %for.inc
