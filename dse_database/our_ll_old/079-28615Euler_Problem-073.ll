...
@g = global [24020000 x i64] zeroinitializer, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx8 = getelementptr inbounds [24020000 x i64], ptr @g, i64 0, i64 %idxprom7
...
for.inc:                                          ; preds = %for.body45
  ...
  %arrayidx49 = getelementptr inbounds [24020000 x i64], ptr @g, i64 0, i64 %idxprom48
  ...
  %arrayidx52 = getelementptr inbounds [24020000 x i64], ptr @g, i64 0, i64 %idxprom51
...
if.else57:                                        ; preds = %if.else15
  ...
  %arrayidx63 = getelementptr inbounds [24020000 x i64], ptr @g, i64 0, i64 %idxprom62
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %arrayidx = getelementptr inbounds [24020000 x i64], ptr @g, i64 0, i64 %add
...
entry:
  ...
  call void @gw(i64 noundef 1, i64 noundef 1, i64 noundef 12000)
  call void @gw(i64 noundef 5, i64 noundef 1, i64 noundef 0)
  call void @gw(i64 noundef 2, i64 noundef 1, i64 noundef 2000)
  call void @gw(i64 noundef 6, i64 noundef 1, i64 noundef 1)
  call void @gw(i64 noundef 7, i64 noundef 1, i64 noundef 1)
  call void @sa(i64 noundef 1)
  call void @sa(i64 noundef 1)
  %call2 = call i64 @gr(i64 noundef 6, i64 noundef 1)
  %cmp = icmp slt i64 1, %call2
  %1 = zext i1 %cmp to i64
  %cond = select i1 %cmp, i32 1, i32 0
  %conv4 = sext i32 %cond to i64
  call void @sa(i64 noundef %conv4)
  br label %_1
...
_2:                                               ; preds = %if.else
  %call8 = call i64 @sp()
  %call9 = call i64 @sr()
  %call10 = call i64 @gr(i64 noundef 1, i64 noundef 1)
...
_3:                                               ; preds = %if.else14
  %call15 = call i64 @gr(i64 noundef 5, i64 noundef 1)
  %call16 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %call15)
  %call17 = call i64 @sp()
  ret i32 0
...
_4:                                               ; preds = %if.then13
  ...
  call void @gw(i64 noundef 6, i64 noundef 1, i64 noundef %div)
  %call21 = call i64 @sr()
  call void @sa(i64 noundef %call21)
  %call22 = call i64 @sp()
  call void @gw(i64 noundef 7, i64 noundef 1, i64 noundef %call22)
  %call23 = call i64 @sr()
  %div24 = sdiv i64 %call23, 3
  %add25 = add nsw i64 %div24, 1
  call void @sa(i64 noundef %add25)
  %call26 = call i64 @sr()
  %call27 = call i64 @gr(i64 noundef 6, i64 noundef 1)
  %cmp28 = icmp slt i64 %call26, %call27
  %2 = zext i1 %cmp28 to i64
  %cond30 = select i1 %cmp28, i32 1, i32 0
  %conv31 = sext i32 %cond30 to i64
  call void @sa(i64 noundef %conv31)
  br label %_1

_5:                                               ; preds = %if.then
  %call32 = call i64 @sr()
  %call33 = call i64 @gr(i64 noundef 2, i64 noundef 1)
  %call34 = call i64 @tm(i64 noundef %call32, i64 noundef %call33)
  %call35 = call i64 @gr(i64 noundef 7, i64 noundef 1)
  %add36 = add nsw i64 %call35, 3
  %call37 = call i64 @gr(i64 noundef %call34, i64 noundef %add36)
...
_6:                                               ; preds = %if.then40
  %call42 = call i64 @gr(i64 noundef 5, i64 noundef 1)
  %add43 = add nsw i64 %call42, 1
  call void @gw(i64 noundef 5, i64 noundef 1, i64 noundef %add43)
  %call44 = call i64 @sr()
  call void @sa(i64 noundef %call44)
  %call45 = call i64 @sp()
  call void @gw(i64 noundef 8, i64 noundef 1, i64 noundef %call45)
  %call46 = call i64 @gr(i64 noundef 7, i64 noundef 1)
  call void @gw(i64 noundef 9, i64 noundef 1, i64 noundef %call46)
  br label %_7

_7:                                               ; preds = %_8, %_6
  %call47 = call i64 @gr(i64 noundef 8, i64 noundef 1)
  %call48 = call i64 @gr(i64 noundef 1, i64 noundef 1)
  %cmp49 = icmp sgt i64 %call47, %call48
  %3 = zext i1 %cmp49 to i64
  %cond51 = select i1 %cmp49, i32 1, i32 0
  %conv52 = sext i32 %cond51 to i64
  %call53 = call i64 @gr(i64 noundef 9, i64 noundef 1)
  %call54 = call i64 @gr(i64 noundef 1, i64 noundef 1)
  %cmp55 = icmp sgt i64 %call53, %call54
  %4 = zext i1 %cmp55 to i64
...
_8:                                               ; preds = %if.else62
  %call63 = call i64 @gr(i64 noundef 8, i64 noundef 1)
  %call64 = call i64 @gr(i64 noundef 2, i64 noundef 1)
  %call65 = call i64 @tm(i64 noundef %call63, i64 noundef %call64)
  %call66 = call i64 @gr(i64 noundef 9, i64 noundef 1)
  %add67 = add nsw i64 %call66, 3
  call void @gw(i64 noundef %call65, i64 noundef %add67, i64 noundef 0)
  %call68 = call i64 @sr()
  %call69 = call i64 @gr(i64 noundef 8, i64 noundef 1)
  %add70 = add nsw i64 %call68, %call69
  call void @gw(i64 noundef 8, i64 noundef 1, i64 noundef %add70)
  %call71 = call i64 @gr(i64 noundef 7, i64 noundef 1)
  %call72 = call i64 @gr(i64 noundef 9, i64 noundef 1)
  %add73 = add nsw i64 %call71, %call72
  call void @gw(i64 noundef 9, i64 noundef 1, i64 noundef %add73)
  br label %_7

_9:                                               ; preds = %if.then61, %if.else41
  %call74 = call i64 @sp()
  %add75 = add nsw i64 %call74, 1
  call void @sa(i64 noundef %add75)
  %call76 = call i64 @sr()
  %call77 = call i64 @gr(i64 noundef 6, i64 noundef 1)
  %cmp78 = icmp slt i64 %call76, %call77
  %5 = zext i1 %cmp78 to i64
  %cond80 = select i1 %cmp78, i32 1, i32 0
  %conv81 = sext i32 %cond80 to i64
  call void @sa(i64 noundef %conv81)
  br label %_1
}
