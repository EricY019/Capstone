...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %conv, i32 noundef %3)
  br label %for.inc
