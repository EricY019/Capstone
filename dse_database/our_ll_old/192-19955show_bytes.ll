...
entry:
  ...
  store i32 -2023406815, ptr %val, align 4
  store ptr %val, ptr %valp, align 8
  %0 = load ptr, ptr %valp, align 8
  call void @show_bytes(ptr noundef %0, i32 noundef 1)
  %1 = load ptr, ptr %valp, align 8
  call void @show_bytes(ptr noundef %1, i32 noundef 2)
  %2 = load ptr, ptr %valp, align 8
  call void @show_bytes(ptr noundef %2, i32 noundef 3)
  store ptr @.str.2, ptr %s, align 8
  %3 = load ptr, ptr %s, align 8
  %4 = load ptr, ptr %s, align 8
  %call = call i64 @strlen(ptr noundef %4) #3
  %conv = trunc i64 %call to i32
  call void @show_bytes(ptr noundef %3, i32 noundef %conv)
  ret i32 0
}
