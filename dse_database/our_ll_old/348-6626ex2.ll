...
entry:
  ...
  %threads = alloca [4 x ptr], align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [4 x ptr], ptr %threads, i64 0, i64 %idxprom
  %call = call i32 @pthread_create(ptr noundef %arrayidx, ptr noundef null, ptr noundef @printStuff, ptr noundef null)
  br label %for.inc
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds [4 x ptr], ptr %threads, i64 0, i64 %idxprom5
