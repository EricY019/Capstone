...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom
...
for.body4:                                        ; preds = %for.cond1
  ...
  %arrayidx6 = getelementptr inbounds [48 x %struct.Entry], ptr @tbl1, i64 0, i64 %idxprom5
  %ascii = getelementptr inbounds %struct.Entry, ptr %arrayidx6, i32 0, i32 0
  %5 = load i8, ptr %ascii, align 1
  %6 = load i32, ptr %i, align 4
  %idxprom7 = sext i32 %6 to i64
  %arrayidx8 = getelementptr inbounds [48 x %struct.Entry], ptr @tbl1, i64 0, i64 %idxprom7
  %key = getelementptr inbounds %struct.Entry, ptr %arrayidx8, i32 0, i32 1
  %7 = load i8, ptr %key, align 1
  %idxprom9 = zext i8 %7 to i64
  %arrayidx10 = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom9
...
for.end13:                                        ; preds = %for.cond1
  ...
  %call22 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
...
for.body32:                                       ; preds = %for.cond29
  ...
  %arrayidx34 = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom33
  %13 = load i8, ptr %arrayidx34, align 1
  %conv35 = zext i8 %13 to i32
  %call36 = call i32 (ptr, ...) @printf(ptr noundef @.str.9, i32 noundef %conv35)
  %14 = load i32, ptr %j, align 4
  %cmp37 = icmp slt i32 %14, 7
  br i1 %cmp37, label %if.then, label %if.end

if.then:                                          ; preds = %for.body32
  %call39 = call i32 (ptr, ...) @printf(ptr noundef @.str.10)
  br label %if.end
...
for.end46:                                        ; preds = %for.cond24
  %call47 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  store i32 0, ptr %i, align 4
  br label %for.cond48
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx53 = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom52
...
for.body61:                                       ; preds = %for.cond57
  ...
  %arrayidx63 = getelementptr inbounds [48 x %struct.Entry], ptr @tbl2, i64 0, i64 %idxprom62
  %ascii64 = getelementptr inbounds %struct.Entry, ptr %arrayidx63, i32 0, i32 0
  %22 = load i8, ptr %ascii64, align 1
  %23 = load i32, ptr %i, align 4
  %idxprom65 = sext i32 %23 to i64
  %arrayidx66 = getelementptr inbounds [48 x %struct.Entry], ptr @tbl2, i64 0, i64 %idxprom65
  %key67 = getelementptr inbounds %struct.Entry, ptr %arrayidx66, i32 0, i32 1
  %24 = load i8, ptr %key67, align 1
  %idxprom68 = zext i8 %24 to i64
  %arrayidx69 = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom68
  store i8 %22, ptr %arrayidx69, align 1
  br label %for.inc70
...
for.body77:                                       ; preds = %for.cond74
  %call78 = call i32 (ptr, ...) @printf(ptr noundef @.str.8)
  store i32 0, ptr %j, align 4
  br label %for.cond79
...
for.body82:                                       ; preds = %for.cond79
  ...
  %arrayidx86 = getelementptr inbounds [256 x i8], ptr %codes, i64 0, i64 %idxprom85
  %30 = load i8, ptr %arrayidx86, align 1
  %conv87 = zext i8 %30 to i32
  %call88 = call i32 (ptr, ...) @printf(ptr noundef @.str.9, i32 noundef %conv87)
  %31 = load i32, ptr %j, align 4
  %cmp89 = icmp slt i32 %31, 7
  br i1 %cmp89, label %if.then91, label %if.end93

if.then91:                                        ; preds = %for.body82
  %call92 = call i32 (ptr, ...) @printf(ptr noundef @.str.10)
  br label %if.end93
...
for.inc94:                                        ; preds = %if.end93
  ...
  store i32 %inc95, ptr %j, align 4
  br label %for.cond79, !llvm.loop !12

for.end96:                                        ; preds = %for.cond79
  %call97 = call i32 (ptr, ...) @printf(ptr noundef @.str.2)
  br label %for.inc98
