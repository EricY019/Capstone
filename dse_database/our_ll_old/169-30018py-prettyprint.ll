...
%struct.lazystring = type { ptr, i32 }
...
@an_int = global i32 -1, align 4
@an_int_type = global i32 1, align 4
@an_int_type2 = global i32 2, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @set_item(ptr noundef %c, i32 noundef %i, i32 noundef %val) #0 {
entry:
  %c.addr = alloca ptr, align 8
  ...
  %len = getelementptr inbounds %struct.container, ptr %1, i32 0, i32 1
...
if.then:                                          ; preds = %entry
  %3 = load i32, ptr %val.addr, align 4
  %4 = load ptr, ptr %c.addr, align 8
  %elements = getelementptr inbounds %struct.container, ptr %4, i32 0, i32 2
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @eval_func(i32 noundef %p1, i32 noundef %p2, i32 noundef %p3, i32 noundef %p4, i32 noundef %p5, i32 noundef %p6, i32 noundef %p7, i32 noundef %p8) #0 {
entry:
  ...
  store i32 %p6, ptr %p6.addr, align 4
  store i32 %p7, ptr %p7.addr, align 4
  store i32 %p8, ptr %p8.addr, align 4
...
entry:
  ...
  %len9 = getelementptr inbounds %struct.lazystring, ptr %estring, i32 0, i32 1
  store i32 -1, ptr %len9, align 8
  %lazy_str10 = getelementptr inbounds %struct.lazystring, ptr %estring2, i32 0, i32 0
  store ptr @.str.9, ptr %lazy_str10, align 8
  %len11 = getelementptr inbounds %struct.lazystring, ptr %estring2, i32 0, i32 1
  store i32 -1, ptr %len11, align 8
  %lazy_str12 = getelementptr inbounds %struct.lazystring, ptr %estring3, i32 0, i32 0
  store ptr null, ptr %lazy_str12, align 8
  %len13 = getelementptr inbounds %struct.lazystring, ptr %estring3, i32 0, i32 1
  store i32 42, ptr %len13, align 8
  call void @add_item(ptr noundef %c, i32 noundef 23)
  call void @add_item(ptr noundef %c, i32 noundef 72)
  %elements14 = getelementptr inbounds %struct.justchildren, ptr %nstype, i32 0, i32 1
  %0 = load ptr, ptr %elements14, align 8
  %arrayidx15 = getelementptr inbounds i32, ptr %0, i64 0
  store i32 7, ptr %arrayidx15, align 4
  %elements16 = getelementptr inbounds %struct.justchildren, ptr %nstype, i32 0, i32 1
  %1 = load ptr, ptr %elements16, align 8
  %arrayidx17 = getelementptr inbounds i32, ptr %1, i64 1
  store i32 42, ptr %arrayidx17, align 4
  %len18 = getelementptr inbounds %struct.justchildren, ptr %nstype, i32 0, i32 0
  store i32 2, ptr %len18, align 8
...
entry:
  %c = alloca %struct.container, align 8
  call void @make_container(ptr dead_on_unwind writable sret(%struct.container) align 8 %c, ptr noundef @.str.10)
  call void @add_item(ptr noundef %c, i32 noundef 71)
  call void @set_item(ptr noundef %c, i32 noundef 0, i32 noundef 42)
  call void @set_item(ptr noundef %c, i32 noundef 0, i32 noundef 5)
  ret void
}
