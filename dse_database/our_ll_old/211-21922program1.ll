; ModuleID = './code/211-21922program1.c'
source_filename = "./code/211-21922program1.c"
...
entry:
  ...
  %primes = alloca [100000 x i32], align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [100000 x i32], ptr %primes, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body3
  ...
  %arrayidx7 = getelementptr inbounds [100000 x i32], ptr %primes, i64 0, i64 %idxprom6
