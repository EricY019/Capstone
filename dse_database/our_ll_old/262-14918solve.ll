...
@__const.main.a = private unnamed_addr constant [4 x i32] [i32 2, i32 3, i32 4, i32 1], align 4
@__const.main.b = private unnamed_addr constant [3 x i32] [i32 1, i32 2, i32 1], align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @maxArea(ptr noundef %a, i32 noundef %n) #0 {
entry:
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 %mul, ptr %area, align 4
  %17 = load i32, ptr %max, align 4
  %18 = load i32, ptr %area, align 4
  %cmp9 = icmp slt i32 %17, %18
  br i1 %cmp9, label %cond.true10, label %cond.false11

cond.true10:                                      ; preds = %cond.end
  %19 = load i32, ptr %area, align 4
  br label %cond.end12
...
cond.end12:                                       ; preds = %cond.false11, %cond.true10
  ...
  store i32 %cond13, ptr %max, align 4
...
while.body:                                       ; preds = %land.end
  ...
  store i32 %inc25, ptr %left, align 4
...
while.body35:                                     ; preds = %land.end34
  %50 = load i32, ptr %right, align 4
  %dec36 = add nsw i32 %50, -1
  store i32 %dec36, ptr %right, align 4
...
entry:
  ...
  %call = call i32 @maxArea(ptr noundef %arraydecay, i32 noundef 4)
  %call1 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %call)
  %arraydecay2 = getelementptr inbounds [3 x i32], ptr %b, i64 0, i64 0
  %call3 = call i32 @maxArea(ptr noundef %arraydecay2, i32 noundef 3)
