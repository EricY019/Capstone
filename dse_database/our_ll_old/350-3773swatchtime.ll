...
entry:
  ...
  store float %div, ptr %swatch, align 4
  %1 = load float, ptr %swatch, align 4
  %conv1 = fpext float %1 to double
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %conv1)
  ret i32 0
}
