...
@__const.main.vector = private unnamed_addr constant [6 x i32] [i32 20, i32 12, i32 7, i32 2, i32 10, i32 35], align 4
@.str = private unnamed_addr constant [4 x i8] c"%d \00", align 1
@.str.1 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @countingSort(ptr noundef %vector, i32 noundef %len, i32 noundef %maxElement) #0 {
entry:
  ...
  store i32 %maxElement, ptr %maxElement.addr, align 4
  %0 = load i32, ptr %maxElement.addr, align 4
  %add = add nsw i32 %0, 1
...
while.body:                                       ; preds = %while.cond
  ...
  %16 = load ptr, ptr %vector.addr, align 8
...
entry:
  ...
  %vector = alloca [6 x i32], align 4
  %len = alloca i32, align 4
  %max = alloca i32, align 4
  %i = alloca i32, align 4
  store i32 0, ptr %retval, align 4
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %vector, ptr align 4 @__const.main.vector, i64 24, i1 false)
  store i32 6, ptr %len, align 4
  store i32 35, ptr %max, align 4
  %arraydecay = getelementptr inbounds [6 x i32], ptr %vector, i64 0, i64 0
  %0 = load i32, ptr %len, align 4
  %1 = load i32, ptr %max, align 4
  call void @countingSort(ptr noundef %arraydecay, i32 noundef %0, i32 noundef %1)
  store i32 0, ptr %i, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [6 x i32], ptr %vector, i64 0, i64 %idxprom
