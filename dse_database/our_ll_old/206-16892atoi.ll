; ModuleID = './code/206-16892atoi.c'
source_filename = "./code/206-16892atoi.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx14.0.0"

@__const.main.str = private unnamed_addr constant [5 x i8] c"1234\00", align 1
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %str, ptr align 1 @__const.main.str, i64 5, i1 false)
  %arraydecay = getelementptr inbounds [5 x i8], ptr %str, i64 0, i64 0
  %call = call i32 @atoi(ptr noundef %arraydecay)
