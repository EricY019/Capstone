; ModuleID = './code/386-2238exemple_calloc_3.c'
source_filename = "./code/386-2238exemple_calloc_3.c"
...
entry:
  ...
  %bloc = alloca [1048576 x ptr], align 8
...
for.body:                                         ; preds = %for.cond
  %call = call ptr @calloc(i64 noundef 1, i64 noundef 257) #3
  %1 = load i32, ptr %i, align 4
  %idxprom = sext i32 %1 to i64
  %arrayidx = getelementptr inbounds [1048576 x ptr], ptr %bloc, i64 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body
  ...
  %call2 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef @.str, i32 noundef %3) #4
  br label %for.end
...
for.end:                                          ; preds = %if.then, %for.cond
  ...
  %call3 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef @.str.1, i32 noundef %6, i32 noundef 0) #4
  ret i32 0
}
