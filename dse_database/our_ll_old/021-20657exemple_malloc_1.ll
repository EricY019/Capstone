...
for.body:                                         ; preds = %for.cond
  %call = call ptr @malloc(i64 noundef 1048576) #3
  %1 = load i32, ptr %i, align 4
  %idxprom = sext i32 %1 to i64
  %arrayidx = getelementptr inbounds [257 x ptr], ptr %bloc, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %if.then, %for.cond
  ...
  %call3 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef @.str.1, i32 noundef %6, i32 noundef 1024) #4
  ret i32 0
}
