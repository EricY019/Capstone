...
define ptr @compute_factorial(ptr noundef %arg) #0 {
entry:
...
for.end:                                          ; preds = %for.cond
  %7 = load i32, ptr %factorial, align 4
...
entry:
  ...
  store i32 10, ptr %number, align 4
  store i32 0, ptr %factorial, align 4
  %call = call i32 @pthread_create(ptr noundef %thread, ptr noundef null, ptr noundef @compute_factorial, ptr noundef %number)
  %0 = load i32, ptr %number, align 4
  %call1 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %0)
  %1 = load ptr, ptr %thread, align 8
  %call2 = call i32 @"\01_pthread_join"(ptr noundef %1, ptr noundef %factorial)
  %2 = load i32, ptr %number, align 4
  %3 = load i32, ptr %factorial, align 4
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %2, i32 noundef %3)
  ret i32 0
}
