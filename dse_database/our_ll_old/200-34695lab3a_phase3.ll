...
entry:
  ...
  %call = call i32 (ptr, i32, ...) @"\01_open"(ptr noundef @.str, i32 noundef 521, i32 noundef 384)
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i64 @"\01_write"(i32 noundef %2, ptr noundef @.str.1, i64 noundef 4)
  br label %for.inc
...
if.else:                                          ; preds = %entry
  call void @perror(ptr noundef @.str.2) #3
  br label %if.end
