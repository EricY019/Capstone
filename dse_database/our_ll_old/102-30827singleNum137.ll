...
@__const.main.x = private unnamed_addr constant [4 x i32] [i32 1, i32 1, i32 1, i32 2], align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @singleNumber(ptr noundef %nums, i32 noundef %numsSize) #0 {
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 4 %c, i8 0, i64 128, i1 false)
...
if.then:                                          ; preds = %for.body3
  ...
  %arrayidx5 = getelementptr inbounds [32 x i32], ptr %c, i64 0, i64 %idxprom4
...
for.end:                                          ; preds = %for.cond1
  ...
  %arrayidx8 = getelementptr inbounds [32 x i32], ptr %c, i64 0, i64 %idxprom7
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %x, ptr align 4 @__const.main.x, i64 16, i1 false)
  %arraydecay = getelementptr inbounds [4 x i32], ptr %x, i64 0, i64 0
  %call = call i32 @singleNumber(ptr noundef %arraydecay, i32 noundef 4)
