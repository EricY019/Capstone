...
@a = global [500 x [500 x double]] zeroinitializer, align 8
@b = global [500 x [500 x double]] zeroinitializer, align 8
@c = global [500 x [500 x double]] zeroinitializer, align 8
...
for.body7:                                        ; preds = %for.cond4
  ...
  %arrayidx = getelementptr inbounds [500 x [500 x double]], ptr @a, i64 0, i64 %idxprom
  %3 = load i32, ptr %i, align 4
  %idxprom10 = sext i32 %3 to i64
  %arrayidx11 = getelementptr inbounds [500 x double], ptr %arrayidx, i64 0, i64 %idxprom10
  ...
  %arrayidx16 = getelementptr inbounds [500 x [500 x double]], ptr @b, i64 0, i64 %idxprom15
  %5 = load i32, ptr %i, align 4
  %idxprom17 = sext i32 %5 to i64
  %arrayidx18 = getelementptr inbounds [500 x double], ptr %arrayidx16, i64 0, i64 %idxprom17
  store double %div14, ptr %arrayidx18, align 8
  %6 = load i32, ptr %j, align 4
  %idxprom19 = sext i32 %6 to i64
  %arrayidx20 = getelementptr inbounds [500 x [500 x double]], ptr @c, i64 0, i64 %idxprom19
  %7 = load i32, ptr %i, align 4
  %idxprom21 = sext i32 %7 to i64
  %arrayidx22 = getelementptr inbounds [500 x double], ptr %arrayidx20, i64 0, i64 %idxprom21
...
for.body46:                                       ; preds = %for.cond43
  ...
  %arrayidx48 = getelementptr inbounds [500 x [500 x double]], ptr @c, i64 0, i64 %idxprom47
  %17 = load i32, ptr %j, align 4
  %idxprom49 = sext i32 %17 to i64
  %arrayidx50 = getelementptr inbounds [500 x double], ptr %arrayidx48, i64 0, i64 %idxprom49
  %18 = load double, ptr %arrayidx50, align 8
  %19 = load i32, ptr %i, align 4
  %idxprom51 = sext i32 %19 to i64
  %arrayidx52 = getelementptr inbounds [500 x [500 x double]], ptr @a, i64 0, i64 %idxprom51
  %20 = load i32, ptr %k, align 4
  %idxprom53 = sext i32 %20 to i64
  %arrayidx54 = getelementptr inbounds [500 x double], ptr %arrayidx52, i64 0, i64 %idxprom53
  %21 = load double, ptr %arrayidx54, align 8
  %22 = load i32, ptr %k, align 4
  %idxprom55 = sext i32 %22 to i64
  %arrayidx56 = getelementptr inbounds [500 x [500 x double]], ptr @b, i64 0, i64 %idxprom55
  %23 = load i32, ptr %j, align 4
  %idxprom57 = sext i32 %23 to i64
  %arrayidx58 = getelementptr inbounds [500 x double], ptr %arrayidx56, i64 0, i64 %idxprom57
  ...
  %arrayidx60 = getelementptr inbounds [500 x [500 x double]], ptr @c, i64 0, i64 %idxprom59
  %27 = load i32, ptr %j, align 4
  %idxprom61 = sext i32 %27 to i64
  %arrayidx62 = getelementptr inbounds [500 x double], ptr %arrayidx60, i64 0, i64 %idxprom61
...
for.end71:                                        ; preds = %for.cond35
  ...
  %div89 = fdiv double 2.500000e+08, %conv88
...
for.body98:                                       ; preds = %for.cond95
  ...
  %arrayidx100 = getelementptr inbounds [500 x [500 x double]], ptr @c, i64 0, i64 %idxprom99
  %42 = load i32, ptr %j, align 4
  %idxprom101 = sext i32 %42 to i64
  %arrayidx102 = getelementptr inbounds [500 x double], ptr %arrayidx100, i64 0, i64 %idxprom101
