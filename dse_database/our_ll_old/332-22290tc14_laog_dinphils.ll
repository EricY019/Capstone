...
%struct.anon = type { %struct._opaque_pthread_mutex_t, [56 x i8] }
%struct._opaque_pthread_mutex_t = type { i64, [56 x i8] }

@chop = internal global [5 x %struct.anon] zeroinitializer, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x %struct.anon], ptr @chop, i64 0, i64 %4
  %m = getelementptr inbounds %struct.anon, ptr %arrayidx, i32 0, i32 0
  %call = call i32 @pthread_mutex_lock(ptr noundef %m)
  %5 = load i64, ptr %right, align 8
  %arrayidx1 = getelementptr inbounds [5 x %struct.anon], ptr @chop, i64 0, i64 %5
  %m2 = getelementptr inbounds %struct.anon, ptr %arrayidx1, i32 0, i32 0
  %call3 = call i32 @pthread_mutex_lock(ptr noundef %m2)
  %6 = load i64, ptr %left, align 8
  %arrayidx4 = getelementptr inbounds [5 x %struct.anon], ptr @chop, i64 0, i64 %6
  %m5 = getelementptr inbounds %struct.anon, ptr %arrayidx4, i32 0, i32 0
  %call6 = call i32 @pthread_mutex_unlock(ptr noundef %m5)
  %7 = load i64, ptr %right, align 8
  %arrayidx7 = getelementptr inbounds [5 x %struct.anon], ptr @chop, i64 0, i64 %7
  %m8 = getelementptr inbounds %struct.anon, ptr %arrayidx7, i32 0, i32 0
  %call9 = call i32 @pthread_mutex_unlock(ptr noundef %m8)
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x %struct.anon], ptr @chop, i64 0, i64 %1
  %m = getelementptr inbounds %struct.anon, ptr %arrayidx, i32 0, i32 0
  %call = call i32 @pthread_mutex_init(ptr noundef %m, ptr noundef null)
  br label %for.inc
