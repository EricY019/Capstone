...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @power(i32 noundef 2, i32 noundef %2)
  %3 = load i32, ptr %i, align 4
  %call2 = call i32 @power(i32 noundef -3, i32 noundef %3)
  %call3 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i32 noundef %1, i32 noundef %call1, i32 noundef %call2)
  br label %for.inc
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @power(i32 noundef %base, i32 noundef %n) #0 {
entry:
