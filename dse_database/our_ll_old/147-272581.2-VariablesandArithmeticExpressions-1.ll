...
while.body:                                       ; preds = %while.cond
  ...
  %div = sdiv i32 %mul, 9
  store i32 %div, ptr %celsius, align 4
  %4 = load i32, ptr %fahr, align 4
  %5 = load i32, ptr %celsius, align 4
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4, i32 noundef %5)
  %6 = load i32, ptr %fahr, align 4
  %7 = load i32, ptr %step, align 4
  %add = add nsw i32 %6, %7
  store i32 %add, ptr %fahr, align 4
