...
define void @printArgs(i32 noundef %argc, ptr noundef %argv) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  call void @printLetters(ptr noundef %4)
  br label %for.inc
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @printLetters(ptr noundef %arg) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @isAlphaOrBlank(i8 noundef signext %5)
...
if.then:                                          ; preds = %for.body
  ...
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %conv, i32 noundef %conv8)
  br label %if.end
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @isAlphaOrBlank(i8 noundef signext %ch) #0 {
entry:
  %ch.addr = alloca i8, align 1
  store i8 %ch, ptr %ch.addr, align 1
  %0 = load i8, ptr %ch.addr, align 1
  %conv = sext i8 %0 to i32
  %call = call i32 @isalpha(i32 noundef %conv) #3
...
lor.rhs:                                          ; preds = %entry
  ...
  %call2 = call i32 @isblank(i32 noundef %conv1) #3
...
entry:
  ...
  call void @printArgs(i32 noundef %0, ptr noundef %1)
  ret i32 0
}
