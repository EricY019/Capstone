...
define i32 @sffoo4(float noundef %x) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usffoo4(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @lsffoo4(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @ulsffoo4(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @dffoo4(double noundef %x) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @udffoo4(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sdffoo4(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usdffoo4(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sffoo8(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usffoo8(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @lsffoo8(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @ulsffoo8(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @dffoo8(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @udffoo8(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sdffoo8(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usdffoo8(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sffoo16(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usffoo16(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @lsffoo16(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @ulsffoo16(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @dffoo16(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @udffoo16(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sdffoo16(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usdffoo16(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sffoo32(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usffoo32(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @lsffoo32(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @ulsffoo32(float noundef %x) #0 {
entry:
  %x.addr = alloca float, align 4
  store float %x, ptr %x.addr, align 4
  %0 = load float, ptr %x.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @dffoo32(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i64 @udffoo32(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @sdffoo32(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @usdffoo32(double noundef %x) #0 {
entry:
  %x.addr = alloca double, align 8
  store double %x, ptr %x.addr, align 8
  %0 = load double, ptr %x.addr, align 8
...
entry:
  ...
  store float 0xBF50624DE0000000, ptr %i, align 4
  br label %for.cond
...
do.body:                                          ; preds = %for.body
  ...
  %call = call i32 @sffoo4(float noundef %1)
...
if.end:                                           ; preds = %do.body
  ...
  %call5 = call i32 @usffoo4(float noundef %3)
...
if.end11:                                         ; preds = %if.end
  ...
  %call12 = call i64 @lsffoo4(float noundef %5)
...
if.end18:                                         ; preds = %if.end11
  ...
  %call19 = call i64 @ulsffoo4(float noundef %7)
...
do.body26:                                        ; preds = %do.end
  %9 = load float, ptr %i, align 4
  %call27 = call i32 @sffoo8(float noundef %9)
...
if.end33:                                         ; preds = %do.body26
  ...
  %call34 = call i32 @usffoo8(float noundef %11)
...
if.end40:                                         ; preds = %if.end33
  %13 = load float, ptr %i, align 4
  %call41 = call i64 @lsffoo8(float noundef %13)
...
if.end47:                                         ; preds = %if.end40
  ...
  %call48 = call i64 @ulsffoo8(float noundef %15)
...
do.body56:                                        ; preds = %do.end55
  ...
  %call57 = call i32 @sffoo16(float noundef %17)
...
if.end63:                                         ; preds = %do.body56
  %19 = load float, ptr %i, align 4
  %call64 = call i32 @usffoo16(float noundef %19)
...
if.end70:                                         ; preds = %if.end63
  %21 = load float, ptr %i, align 4
  %call71 = call i64 @lsffoo16(float noundef %21)
...
if.end77:                                         ; preds = %if.end70
  %23 = load float, ptr %i, align 4
  %call78 = call i64 @ulsffoo16(float noundef %23)
  %24 = load float, ptr %i, align 4
...
do.body86:                                        ; preds = %do.end85
  %25 = load float, ptr %i, align 4
  %call87 = call i32 @sffoo32(float noundef %25)
  %26 = load float, ptr %i, align 4
...
if.end93:                                         ; preds = %do.body86
  ...
  %call94 = call i32 @usffoo32(float noundef %27)
  %28 = load float, ptr %i, align 4
...
if.end100:                                        ; preds = %if.end93
  %29 = load float, ptr %i, align 4
  %call101 = call i64 @lsffoo32(float noundef %29)
  %30 = load float, ptr %i, align 4
...
if.end107:                                        ; preds = %if.end100
  ...
  %call108 = call i64 @ulsffoo32(float noundef %31)
  %32 = load float, ptr %i, align 4
...
do.body116:                                       ; preds = %do.end115
  ...
  %call118 = call i64 @dffoo4(double noundef %conv117)
  %34 = load float, ptr %i, align 4
...
if.end124:                                        ; preds = %do.body116
  %35 = load float, ptr %i, align 4
  %conv125 = fpext float %35 to double
  %call126 = call i64 @udffoo4(double noundef %conv125)
...
if.end132:                                        ; preds = %if.end124
  %37 = load float, ptr %i, align 4
  %conv133 = fpext float %37 to double
  %call134 = call i32 @sdffoo4(double noundef %conv133)
...
if.end140:                                        ; preds = %if.end132
  %39 = load float, ptr %i, align 4
  %conv141 = fpext float %39 to double
  %call142 = call i32 @usdffoo4(double noundef %conv141)
  %40 = load float, ptr %i, align 4
...
do.body150:                                       ; preds = %do.end149
  %41 = load float, ptr %i, align 4
  %conv151 = fpext float %41 to double
  %call152 = call i64 @dffoo8(double noundef %conv151)
...
if.end158:                                        ; preds = %do.body150
  ...
  %call160 = call i64 @udffoo8(double noundef %conv159)
  %44 = load float, ptr %i, align 4
...
if.end166:                                        ; preds = %if.end158
  %45 = load float, ptr %i, align 4
  %conv167 = fpext float %45 to double
  %call168 = call i32 @sdffoo8(double noundef %conv167)
  %46 = load float, ptr %i, align 4
...
if.end174:                                        ; preds = %if.end166
  %47 = load float, ptr %i, align 4
  %conv175 = fpext float %47 to double
  %call176 = call i32 @usdffoo8(double noundef %conv175)
...
do.body184:                                       ; preds = %do.end183
  %49 = load float, ptr %i, align 4
  %conv185 = fpext float %49 to double
  %call186 = call i64 @dffoo16(double noundef %conv185)
  %50 = load float, ptr %i, align 4
...
if.end192:                                        ; preds = %do.body184
  %51 = load float, ptr %i, align 4
  %conv193 = fpext float %51 to double
  %call194 = call i64 @udffoo16(double noundef %conv193)
  %52 = load float, ptr %i, align 4
...
if.end200:                                        ; preds = %if.end192
  %53 = load float, ptr %i, align 4
  %conv201 = fpext float %53 to double
  %call202 = call i32 @sdffoo16(double noundef %conv201)
  %54 = load float, ptr %i, align 4
...
if.end208:                                        ; preds = %if.end200
  %55 = load float, ptr %i, align 4
  %conv209 = fpext float %55 to double
  %call210 = call i32 @usdffoo16(double noundef %conv209)
...
do.body218:                                       ; preds = %do.end217
  %57 = load float, ptr %i, align 4
  %conv219 = fpext float %57 to double
  %call220 = call i64 @dffoo32(double noundef %conv219)
  %58 = load float, ptr %i, align 4
...
if.end226:                                        ; preds = %do.body218
  %59 = load float, ptr %i, align 4
  %conv227 = fpext float %59 to double
  %call228 = call i64 @udffoo32(double noundef %conv227)
...
if.end234:                                        ; preds = %if.end226
  %61 = load float, ptr %i, align 4
  %conv235 = fpext float %61 to double
  %call236 = call i32 @sdffoo32(double noundef %conv235)
  %62 = load float, ptr %i, align 4
...
if.end242:                                        ; preds = %if.end234
  %63 = load float, ptr %i, align 4
  %conv243 = fpext float %63 to double
  %call244 = call i32 @usdffoo32(double noundef %conv243)
  %64 = load float, ptr %i, align 4
