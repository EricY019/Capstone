...
entry:
  ...
  %call = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef 8888)
...
for.end8:                                         ; preds = %for.cond
  ...
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5)
  %call10 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef 8888)
  ret i32 0
}
