...
entry:
  ...
  store i32 0, ptr %third, align 4
  br label %while.cond

while.cond:                                       ; preds = %if.end, %entry
  %0 = load i32, ptr %third, align 4
...
while.body:                                       ; preds = %while.cond
  ...
  %add = add nsw i32 %1, %2
  store i32 %add, ptr %third, align 4
  %3 = load i32, ptr %third, align 4
  %rem = srem i32 %3, 2
  %cmp1 = icmp eq i32 %rem, 0
  br i1 %cmp1, label %if.then, label %if.end

if.then:                                          ; preds = %while.body
  %4 = load i32, ptr %third, align 4
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  store i32 %6, ptr %first, align 4
  %7 = load i32, ptr %third, align 4
