...
@__const.main.array = private unnamed_addr constant [5 x i32] [i32 122, i32 17, i32 93, i32 3, i32 56], align 4

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @insertionSort(ptr noundef %array, i32 noundef %n) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %4, ptr %element, align 4
...
while.end:                                        ; preds = %land.end
  %18 = load i32, ptr %element, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @printArray(ptr noundef %array, i32 noundef %n) #0 {
entry:
  %array.addr = alloca ptr, align 8
  %n.addr = alloca i32, align 4
  %i = alloca i32, align 4
...
entry:
  ...
  call void @insertionSort(ptr noundef %arraydecay, i32 noundef %0)
  %arraydecay1 = getelementptr inbounds [5 x i32], ptr %array, i64 0, i64 0
  %1 = load i32, ptr %n, align 4
  call void @printArray(ptr noundef %arraydecay1, i32 noundef %1)
  ret i32 0
}
