...
define i64 @factorial(i64 noundef %n) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @trailing_zeros(i64 noundef %n) #0 {
entry:
  %n.addr = alloca i64, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @powers_of_five(i32 noundef %n) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @direct_trailing_zeros(i32 noundef %n) #0 {
entry:
  %n.addr = alloca i32, align 4
...
if.then:                                          ; preds = %for.body
  ...
  %call = call i32 @powers_of_five(i32 noundef %2)
...
entry:
  ...
  %call = call i32 @direct_trailing_zeros(i32 noundef %1)
