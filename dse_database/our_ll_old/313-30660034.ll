...
@fact = constant [10 x i32] [i32 1, i32 1, i32 2, i32 6, i32 24, i32 120, i32 720, i32 5040, i32 40320, i32 362880], align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @fact_digsum(i32 noundef %n) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %arrayidx = getelementptr inbounds [10 x i32], ptr @fact, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @fact_digsum(i32 noundef %1)
