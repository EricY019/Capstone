...
for.end:                                          ; preds = %for.cond
  ...
  %call5 = call i32 @jump(ptr noundef %10, i32 noundef %11)
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal i32 @jump(ptr noundef %nums, i32 noundef %numsSize) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @max(i32 noundef %add, i32 noundef %9)
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 %add2, ptr %lo, align 4
  %12 = load i32, ptr %right, align 4
  store i32 %12, ptr %hi, align 4
  %13 = load i32, ptr %steps, align 4
  %inc3 = add nsw i32 %13, 1
  store i32 %inc3, ptr %steps, align 4
