; ModuleID = './code/305-16651data.c'
source_filename = "./code/305-16651data.c"
...
entry:
  ...
  %call2 = call i32 (ptr, ...) @printf(ptr noundef @.str.2, i32 noundef 10001)
  store i32 0, ptr %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %1 = load i32, ptr %i, align 4
  %cmp = icmp slt i32 %1, 10001
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call4 = call i32 @rand()
  %2 = call i32 @llvm.abs.i32(i32 %call4, i1 true)
  %call5 = call i32 (ptr, ...) @printf(ptr noundef @.str.3, i32 noundef %2)
  br label %for.inc
