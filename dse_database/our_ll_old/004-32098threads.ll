...
@a = global [1000 x double] zeroinitializer, align 8

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @main() #0 {
entry:
  %retval = alloca i32, align 4
  %t = alloca [4 x ptr], align 8
  %sum = alloca [4 x double], align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [4 x double], ptr %sum, i64 0, i64 %idxprom1
  %call = call i32 @pthread_create(ptr noundef %arrayidx, ptr noundef null, ptr noundef @th, ptr noundef %arrayidx2)
  br label %for.inc
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx7 = getelementptr inbounds [4 x ptr], ptr %t, i64 0, i64 %idxprom6
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal ptr @th(ptr noundef %v) #0 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds [1000 x double], ptr @a, i64 0, i64 %idxprom
