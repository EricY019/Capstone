...
@g = global [1540 x i64] zeroinitializer, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx8 = getelementptr inbounds [1540 x i64], ptr @g, i64 0, i64 %idxprom7
...
for.inc:                                          ; preds = %for.body45
  ...
  %arrayidx49 = getelementptr inbounds [1540 x i64], ptr @g, i64 0, i64 %idxprom48
  ...
  %arrayidx52 = getelementptr inbounds [1540 x i64], ptr @g, i64 0, i64 %idxprom51
...
if.else57:                                        ; preds = %if.else15
  ...
  %arrayidx63 = getelementptr inbounds [1540 x i64], ptr @g, i64 0, i64 %idxprom62
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %arrayidx = getelementptr inbounds [1540 x i64], ptr @g, i64 0, i64 %add
...
entry:
  ...
  %call3 = call ptr @calloc(i64 noundef %conv2, i64 noundef 8) #5
  store ptr %call3, ptr @s, align 8
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 0)
  call void @gw(i64 noundef 41, i64 noundef 1, i64 noundef 0)
  call void @sa(i64 noundef 1000000)
  call void @sa(i64 noundef 39)
  call void @sa(i64 noundef 39)
  br label %_1
...
_3:                                               ; preds = %if.then96, %_2
  %call7 = call i64 @gr(i64 noundef 4, i64 noundef 0)
  call void @sa(i64 noundef %call7)
  %call8 = call i64 @gr(i64 noundef 4, i64 noundef 0)
  %add = add nsw i64 %call8, 2
  %call9 = call i64 @gr(i64 noundef 4, i64 noundef 0)
  %add10 = add nsw i64 %call9, 2
  %call11 = call i64 @gr(i64 noundef %add10, i64 noundef 1)
  %add12 = add nsw i64 %call11, 1
  call void @gw(i64 noundef %add, i64 noundef 1, i64 noundef %add12)
  %call13 = call i32 @rd()
...
_7:                                               ; preds = %if.else35
  ...
  call void @sa(i64 noundef %add37)
  br label %_8
...
_8:                                               ; preds = %_94, %_93, %_92, %_7
  ...
  call void @sa(i64 noundef %add40)
  %call41 = call i64 @sp()
  %rem = srem i64 %call41, 40
  call void @sa(i64 noundef %rem)
  %call42 = call i64 @sr()
  call void @sa(i64 noundef %call42)
  %call43 = call i64 @sp()
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef %call43)
  %call44 = call i32 @rd()
...
_12:                                              ; preds = %if.else67
  ...
  call void @sa(i64 noundef %add69)
  br label %_13
...
_15:                                              ; preds = %if.else82
  ...
  call void @sa(i64 noundef %add84)
  br label %_16
...
_17:                                              ; preds = %if.else240, %if.else202, %if.else89
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 10)
  %call90 = call i64 @sp()
  br label %_18
...
_19:                                              ; preds = %if.else97
  call void @gw(i64 noundef 41, i64 noundef 2, i64 noundef 39)
  %call98 = call i64 @sp()
  call void @sa(i64 noundef 39)
  call void @sa(i64 noundef 39)
  br label %_20
...
_24:                                              ; preds = %if.then114
  %call116 = call i64 @sr()
  call void @sa(i64 noundef %call116)
  %call117 = call i64 @sr()
  %add118 = add nsw i64 %call117, 1
  %call119 = call i64 @gr(i64 noundef %add118, i64 noundef 2)
  %add120 = add nsw i64 %call119, 2
  %call121 = call i64 @gr(i64 noundef %add120, i64 noundef 1)
  store i64 %call121, ptr %t0, align 8
  %call122 = call i64 @sp()
  %add123 = add nsw i64 %call122, 2
  call void @sa(i64 noundef %add123)
  call void @sa(i64 noundef 2)
  %call124 = call i64 @sp()
  store i64 %call124, ptr %v0, align 8
  %call125 = call i64 @sp()
  %1 = load i64, ptr %v0, align 8
  %call126 = call i64 @gr(i64 noundef %call125, i64 noundef %1)
  call void @sa(i64 noundef %call126)
  %call127 = call i64 @sp()
  %add128 = add nsw i64 %call127, 2
  call void @sa(i64 noundef %add128)
  call void @sa(i64 noundef 1)
  %call130 = call i64 @sp()
  store i64 %call130, ptr %v0129, align 8
  %call131 = call i64 @sp()
  %2 = load i64, ptr %v0129, align 8
  %call132 = call i64 @gr(i64 noundef %call131, i64 noundef %2)
  store i64 %call132, ptr %t1, align 8
  %3 = load i64, ptr %t0, align 8
  %4 = load i64, ptr %t1, align 8
  %cmp133 = icmp slt i64 %3, %4
  %5 = zext i1 %cmp133 to i64
  %cond = select i1 %cmp133, i32 1, i32 0
  %conv135 = sext i32 %cond to i64
  store i64 %conv135, ptr %t2, align 8
  %6 = load i64, ptr %t2, align 8
  %cmp136 = icmp ne i64 %6, 0
...
_25:                                              ; preds = %if.then138
  ...
  %call142 = call i64 @gr(i64 noundef %add141, i64 noundef 2)
  call void @gw(i64 noundef 5, i64 noundef 0, i64 noundef %call142)
  %call143 = call i64 @sr()
  call void @sa(i64 noundef %call143)
  %call144 = call i64 @sr()
  %add145 = add nsw i64 %call144, 1
  %call146 = call i64 @gr(i64 noundef %add145, i64 noundef 2)
  call void @sa(i64 noundef %call146)
  %call148 = call i64 @sp()
  store i64 %call148, ptr %v0147, align 8
  %call149 = call i64 @sp()
  store i64 %call149, ptr %v1, align 8
  %7 = load i64, ptr %v0147, align 8
  call void @sa(i64 noundef %7)
  %8 = load i64, ptr %v1, align 8
  call void @sa(i64 noundef %8)
  %call150 = call i64 @sp()
  %add151 = add nsw i64 %call150, 2
  call void @sa(i64 noundef %add151)
  call void @sa(i64 noundef 2)
  %call153 = call i64 @sp()
  store i64 %call153, ptr %v0152, align 8
  %call155 = call i64 @sp()
  store i64 %call155, ptr %v1154, align 8
  %9 = load i64, ptr %v1154, align 8
  %10 = load i64, ptr %v0152, align 8
  %call156 = call i64 @sp()
  call void @gw(i64 noundef %9, i64 noundef %10, i64 noundef %call156)
  %call157 = call i64 @sp()
  %sub158 = sub nsw i64 %call157, 1
  call void @sa(i64 noundef %sub158)
  %call159 = call i64 @sr()
  %add160 = add nsw i64 %call159, 2
  call void @sa(i64 noundef %add160)
  %call161 = call i64 @gr(i64 noundef 5, i64 noundef 0)
  call void @sa(i64 noundef %call161)
  %call163 = call i64 @sp()
  store i64 %call163, ptr %v0162, align 8
  %call165 = call i64 @sp()
  store i64 %call165, ptr %v1164, align 8
  %11 = load i64, ptr %v0162, align 8
  call void @sa(i64 noundef %11)
  %12 = load i64, ptr %v1164, align 8
  call void @sa(i64 noundef %12)
  call void @sa(i64 noundef 2)
  %call167 = call i64 @sp()
  store i64 %call167, ptr %v0166, align 8
  %call169 = call i64 @sp()
  store i64 %call169, ptr %v1168, align 8
  %13 = load i64, ptr %v1168, align 8
  %14 = load i64, ptr %v0166, align 8
  %call170 = call i64 @sp()
  call void @gw(i64 noundef %13, i64 noundef %14, i64 noundef %call170)
  %call171 = call i64 @sp()
  %sub172 = sub nsw i64 %call171, 1
  call void @sa(i64 noundef %sub172)
  br label %_23

_26:                                              ; preds = %if.else139, %if.else115
  %call173 = call i64 @sp()
  %add174 = add nsw i64 %call173, 1
  call void @sa(i64 noundef %add174)
  %call175 = call i64 @sr()
  %cmp176 = icmp slt i64 %call175, 40
  %15 = zext i1 %cmp176 to i64
  %cond178 = select i1 %cmp176, i32 1, i32 0
  %conv179 = sext i32 %cond178 to i64
  call void @sa(i64 noundef %conv179)
  br label %_22

_27:                                              ; preds = %if.else109
  %call180 = call i64 @gr(i64 noundef 2, i64 noundef 2)
  %call181 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %call180)
  %call182 = call i64 @gr(i64 noundef 3, i64 noundef 2)
  %call183 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %call182)
  %call184 = call i64 @gr(i64 noundef 4, i64 noundef 2)
  %call185 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, i64 noundef %call184)
  %call186 = call i64 @sp()
  ret i32 0
...
_28:                                              ; preds = %if.then102
  ...
  call void @sa(i64 noundef %sub188)
  %call189 = call i64 @sr()
  call void @sa(i64 noundef %call189)
  %call190 = call i64 @sr()
  %add191 = add nsw i64 %call190, 2
  call void @sa(i64 noundef %add191)
  call void @sa(i64 noundef 2)
  %call193 = call i64 @sp()
  store i64 %call193, ptr %v0192, align 8
  %call195 = call i64 @sp()
  store i64 %call195, ptr %v1194, align 8
  %16 = load i64, ptr %v1194, align 8
  %17 = load i64, ptr %v0192, align 8
  %call196 = call i64 @sp()
  call void @gw(i64 noundef %16, i64 noundef %17, i64 noundef %call196)
  %call197 = call i64 @sr()
  call void @sa(i64 noundef %call197)
  br label %_20
...
_35:                                              ; preds = %if.else232
  ...
  call void @sa(i64 noundef %add234)
  br label %_36
...
_37:                                              ; preds = %if.then239
  ...
  call void @sa(i64 noundef %sub242)
  %call243 = call i64 @sp()
...
_52:                                              ; preds = %if.else293
  ...
  call void @sa(i64 noundef %add295)
  br label %_53

_53:                                              ; preds = %_77, %_76, %_75, %_52
  %call296 = call i64 @sr()
  call void @sa(i64 noundef %call296)
  %call297 = call i64 @sp()
...
_54:                                              ; preds = %if.then300
  ...
  call void @sa(i64 noundef %sub303)
  %call304 = call i64 @sr()
  call void @sa(i64 noundef %call304)
  %call305 = call i64 @sp()
...
_55:                                              ; preds = %if.then308
  ...
  call void @sa(i64 noundef %sub311)
  %call312 = call i64 @sr()
  call void @sa(i64 noundef %call312)
  %call313 = call i64 @sp()
...
_56:                                              ; preds = %if.then316
  ...
  call void @sa(i64 noundef %sub319)
  %call320 = call i64 @sr()
  call void @sa(i64 noundef %call320)
  %call321 = call i64 @sp()
...
_57:                                              ; preds = %if.then324
  ...
  call void @sa(i64 noundef %sub327)
  %call328 = call i64 @sr()
  call void @sa(i64 noundef %call328)
  %call329 = call i64 @sp()
...
_58:                                              ; preds = %if.then332
  ...
  call void @sa(i64 noundef %sub335)
  %call336 = call i64 @sr()
  call void @sa(i64 noundef %call336)
  %call337 = call i64 @sp()
...
_59:                                              ; preds = %if.then340
  ...
  call void @sa(i64 noundef %sub343)
  %call344 = call i64 @sr()
  call void @sa(i64 noundef %call344)
  %call345 = call i64 @sp()
...
_60:                                              ; preds = %if.then348
  ...
  call void @sa(i64 noundef %sub351)
  %call352 = call i64 @sr()
  call void @sa(i64 noundef %call352)
  %call353 = call i64 @sp()
...
_61:                                              ; preds = %if.then356
  ...
  call void @sa(i64 noundef %sub359)
  %call360 = call i64 @sr()
  call void @sa(i64 noundef %call360)
  %call361 = call i64 @sp()
...
_62:                                              ; preds = %if.then364
  ...
  call void @sa(i64 noundef %sub367)
  %call368 = call i64 @sr()
  call void @sa(i64 noundef %call368)
  %call369 = call i64 @sp()
...
_64:                                              ; preds = %if.else373
  %call375 = call i64 @gr(i64 noundef 4, i64 noundef 0)
  %sub376 = sub nsw i64 %call375, 3
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef %sub376)
  br label %_63

_65:                                              ; preds = %if.else365
  %call377 = call i64 @gr(i64 noundef 4, i64 noundef 0)
...
_66:                                              ; preds = %if.then380
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 12)
  br label %_63

_67:                                              ; preds = %if.else381
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 28)
  br label %_63

_68:                                              ; preds = %if.else357, %if.else349
  %call382 = call i64 @gr(i64 noundef 4, i64 noundef 0)
  ...
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef %add386)
  br label %_63
...
_70:                                              ; preds = %if.else333
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 5)
  br label %_63

_71:                                              ; preds = %if.else325
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 39)
  br label %_63
...
_73:                                              ; preds = %if.else309
  call void @gw(i64 noundef 4, i64 noundef 0, i64 noundef 11)
  br label %_63
...
_83:                                              ; preds = %if.then81
  ...
  call void @sa(i64 noundef %add404)
  br label %_16

_84:                                              ; preds = %if.else77
  %call405 = call i64 @sp()
  %add406 = add nsw i64 %call405, 3
  call void @sa(i64 noundef %add406)
  br label %_16

_85:                                              ; preds = %if.then76
  %call407 = call i64 @sp()
  %add408 = add nsw i64 %call407, 0
  call void @sa(i64 noundef %add408)
  br label %_16

_86:                                              ; preds = %if.then66
  %call409 = call i64 @sp()
  %add410 = add nsw i64 %call409, 1
  call void @sa(i64 noundef %add410)
  br label %_13

_87:                                              ; preds = %if.else62
  %call411 = call i64 @sp()
  %add412 = add nsw i64 %call411, 3
  call void @sa(i64 noundef %add412)
  br label %_13

_88:                                              ; preds = %if.then61
  %call413 = call i64 @sp()
  %add414 = add nsw i64 %call413, 0
  call void @sa(i64 noundef %add414)
  br label %_13
...
_92:                                              ; preds = %if.then34
  ...
  call void @sa(i64 noundef %add416)
  br label %_8

_93:                                              ; preds = %if.else30
  %call417 = call i64 @sp()
  %add418 = add nsw i64 %call417, 4
  call void @sa(i64 noundef %add418)
  br label %_8

_94:                                              ; preds = %if.then29
  %call419 = call i64 @sp()
  %add420 = add nsw i64 %call419, 1
  call void @sa(i64 noundef %add420)
  br label %_8
...
_98:                                              ; preds = %if.then
  ...
  call void @sa(i64 noundef %sub422)
  %call423 = call i64 @sr()
  %add424 = add nsw i64 %call423, 2
  call void @sa(i64 noundef %add424)
  call void @sa(i64 noundef 0)
  %call426 = call i64 @sp()
  store i64 %call426, ptr %v0425, align 8
  %call428 = call i64 @sp()
  store i64 %call428, ptr %v1427, align 8
  %18 = load i64, ptr %v0425, align 8
  call void @sa(i64 noundef %18)
  %19 = load i64, ptr %v1427, align 8
  call void @sa(i64 noundef %19)
  call void @sa(i64 noundef 1)
  %call430 = call i64 @sp()
  store i64 %call430, ptr %v0429, align 8
  %call432 = call i64 @sp()
  store i64 %call432, ptr %v1431, align 8
  %20 = load i64, ptr %v1431, align 8
  %21 = load i64, ptr %v0429, align 8
  %call433 = call i64 @sp()
  call void @gw(i64 noundef %20, i64 noundef %21, i64 noundef %call433)
  %call434 = call i64 @sr()
  call void @sa(i64 noundef %call434)
  br label %_1
}
