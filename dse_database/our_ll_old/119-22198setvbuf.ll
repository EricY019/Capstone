...
define void @delay(i32 noundef %sec) #0 {
entry:
  ...
  store i64 %call, ptr %ticks1, align 8
...
entry:
  ...
  %call = call i32 @setvbuf(ptr noundef %0, ptr noundef null, i32 noundef 0, i64 noundef 5)
  %call1 = call i32 (ptr, ...) @printf(ptr noundef @.str)
  call void @delay(i32 noundef 3)
  ret i32 0
}
