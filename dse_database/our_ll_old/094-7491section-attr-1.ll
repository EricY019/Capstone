; ModuleID = './code/094-7491section-attr-1.c'
source_filename = "./code/094-7491section-attr-1.c"
...
define i32 @main(i32 noundef %argc, ptr noundef %argv) #0 section "__TEXT,__text" {
entry:
