...
@__const.main.array = private unnamed_addr constant [5 x i32] [i32 1, i32 1, i32 1, i32 0, i32 1], align 4
@.str = private unnamed_addr constant [4 x i8] c"%d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @findMinNumberInRotatedArray(ptr noundef %array, i32 noundef %low, i32 noundef %high) #0 {
entry:
...
if.end8:                                          ; preds = %if.end
  ...
  %add = add nsw i32 %8, %9
  %div = sdiv i32 %add, 2
  store i32 %div, ptr %medium, align 4
...
if.then12:                                        ; preds = %if.end8
  ...
  %17 = load i32, ptr %medium, align 4
  %18 = load i32, ptr %high.addr, align 4
  %call = call i32 @findMinNumberInRotatedArray(ptr noundef %16, i32 noundef %17, i32 noundef %18)
  store i32 %call, ptr %position, align 4
  br label %if.end21

if.else:                                          ; preds = %if.end8
  %19 = load ptr, ptr %array.addr, align 8
  %20 = load i32, ptr %medium, align 4
...
if.then18:                                        ; preds = %if.else
  ...
  %26 = load i32, ptr %low.addr, align 4
  %27 = load i32, ptr %medium, align 4
  %call19 = call i32 @findMinNumberInRotatedArray(ptr noundef %25, i32 noundef %26, i32 noundef %27)
  store i32 %call19, ptr %position, align 4
  br label %if.end20
...
if.end21:                                         ; preds = %if.end20, %if.then12
  %28 = load i32, ptr %position, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @findMinNumberInRotatedArray_loop(ptr noundef %array, i32 noundef %low, i32 noundef %high) #0 {
entry:
  %retval = alloca i32, align 4
  %array.addr = alloca ptr, align 8
  %low.addr = alloca i32, align 4
...
if.then10:                                        ; preds = %while.body
  %15 = load i32, ptr %medium, align 4
  store i32 %15, ptr %low.addr, align 4
  br label %if.end18
...
if.then16:                                        ; preds = %if.else
  %22 = load i32, ptr %medium, align 4
  store i32 %22, ptr %high.addr, align 4
  br label %if.end17
...
while.end:                                        ; preds = %while.cond
  %23 = load i32, ptr %high.addr, align 4
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define i32 @findMinNumberInRotatedArray_improved(ptr noundef %array, i32 noundef %length) #0 {
entry:
  %retval = alloca i32, align 4
  %array.addr = alloca ptr, align 8
  ...
  store i32 %1, ptr %medium, align 4
  br label %while.cond
...
if.then:                                          ; preds = %while.body
  ...
  store i32 %12, ptr %medium, align 4
  br label %while.end
...
if.then15:                                        ; preds = %land.lhs.true
  ...
  store i32 %27, ptr %min, align 4
  %28 = load i32, ptr %low, align 4
...
if.else:                                          ; preds = %if.end26
  ...
  %51 = load i32, ptr %low, align 4
  %idxprom35 = sext i32 %51 to i64
  %arrayidx36 = getelementptr inbounds i32, ptr %50, i64 %idxprom35
  %52 = load i32, ptr %arrayidx36, align 4
  %cmp37 = icmp sle i32 %49, %52
  br i1 %cmp37, label %if.then38, label %if.end39

if.then38:                                        ; preds = %if.else
  %53 = load i32, ptr %medium, align 4
  store i32 %53, ptr %high, align 4
  br label %if.end39
...
while.end:                                        ; preds = %if.then, %while.cond
  %54 = load i32, ptr %medium, align 4
...
entry:
  ...
  %call = call i32 @findMinNumberInRotatedArray_improved(ptr noundef %arraydecay, i32 noundef 5)
  store i32 %call, ptr %position, align 4
