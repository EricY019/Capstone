...
@mutex_stdout = global %struct._opaque_pthread_mutex_t { i64 850045863, [56 x i8] zeroinitializer }, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @pthread_create(ptr noundef %thread, ptr noundef null, ptr noundef @routine_threads, ptr noundef %2)
  br label %for.inc
...
; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define internal ptr @routine_threads(ptr noundef %argument) #0 {
entry:
  ...
  %0 = load ptr, ptr %argument.addr, align 8
  %1 = ptrtoint ptr %0 to i32
  store i32 %1, ptr %numero, align 4
  %call = call i32 @aleatoire(i32 noundef 6)
  store i32 %call, ptr %nombre_iterations, align 4
  store i32 0, ptr %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %2 = load i32, ptr %i, align 4
  %3 = load i32, ptr %nombre_iterations, align 4
  %cmp = icmp slt i32 %2, %3
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %call1 = call i32 @aleatoire(i32 noundef 3)
  %call2 = call i32 @"\01_sleep"(i32 noundef %call1)
  %call3 = call i32 @pthread_mutex_lock(ptr noundef @mutex_stdout)
  %4 = load ptr, ptr @__stdoutp, align 8
  %5 = load i32, ptr %numero, align 4
  %call4 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef @.str, i32 noundef %5) #5
  %call5 = call i32 @pthread_mutex_unlock(ptr noundef @mutex_stdout)
  br label %for.inc
