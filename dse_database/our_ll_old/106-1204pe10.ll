...
define i32 @isPrime(i32 noundef %number) #0 {
entry:
...
entry:
  ...
  store i64 0, ptr %primesum, align 8
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %1 = load i64, ptr @primebelow, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %5 = load i64, ptr %primesum, align 8
  %add = add i64 %5, %conv3
  store i64 %add, ptr %primesum, align 8
  br label %if.end
...
for.end:                                          ; preds = %for.cond
  %7 = load i64, ptr %primesum, align 8
  store i64 %7, ptr @euler, align 8
  %8 = load i64, ptr @euler, align 8
