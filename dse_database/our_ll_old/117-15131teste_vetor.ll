; ModuleID = './code/117-15131teste_vetor.c'
source_filename = "./code/117-15131teste_vetor.c"
target datalayout = "e-m:o-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx14.0.0"

@.str = private unnamed_addr constant [12 x i8] c"v[%d] = %d\0A\00", align 1

; Function Attrs: noinline nounwind optnone ssp uwtable(sync)
define void @geraValoresVetor(ptr noundef %v) #0 {
entry:
...
for.body6:                                        ; preds = %for.cond3
  ...
  %call9 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %5, i32 noundef %8)
  br label %for.inc10
...
entry:
  ...
  %arraydecay = getelementptr inbounds [15 x i32], ptr %v, i64 0, i64 0
  call void @geraValoresVetor(ptr noundef %arraydecay)
  ret i32 0
}
