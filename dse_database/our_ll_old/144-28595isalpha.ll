...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %s, ptr align 1 @__const.main.s, i64 12, i1 false)
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @isalpha(i32 noundef %conv4) #4
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx6 = getelementptr inbounds [12 x i8], ptr %s, i64 0, i64 %idxprom5
  %6 = load i8, ptr %arrayidx6, align 1
  %conv7 = sext i8 %6 to i32
  %call8 = call i32 (ptr, ...) @printf(ptr noundef @.str, i32 noundef %4, i32 noundef %conv7)
  br label %if.end
