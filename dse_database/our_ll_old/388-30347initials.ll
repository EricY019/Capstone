...
for.body:                                         ; preds = %for.cond
  ...
  store i8 %5, ptr %inital, align 1
  %6 = load i8, ptr %inital, align 1
  %conv = sext i8 %6 to i32
  %call = call i32 @islower(i32 noundef %conv) #3
  %tobool = icmp ne i32 %call, 0
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %7 = load i8, ptr %inital, align 1
  %conv2 = sext i8 %7 to i32
  %call3 = call i32 @toupper(i32 noundef %conv2) #3
  %conv4 = trunc i32 %call3 to i8
  store i8 %conv4, ptr %inital, align 1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %8 = load i8, ptr %inital, align 1
