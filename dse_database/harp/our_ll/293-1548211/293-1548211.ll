...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx14 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx11, i64 0, i64 %idxprom13
  ...
  store i32 %mul21, i32* %tmp, align 4
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  store i32 %mul44, i32* %tmp, align 4
...
cond.end48:                                       ; preds = %cond.false47, %cond.true46
  ...
  store i32 %cond49, i32* %max, align 4
  ...
  %42 = load i32, i32* %arrayidx66, align 4
  ...
  store i32 %mul74, i32* %tmp, align 4
...
cond.end78:                                       ; preds = %cond.false77, %cond.true76
  ...
  store i32 %cond79, i32* %max, align 4
...
if.then:                                          ; preds = %cond.end78
  ...
  store i32 %mul104, i32* %tmp, align 4
...
cond.end108:                                      ; preds = %cond.false107, %cond.true106
  ...
  store i32 %cond109, i32* %max, align 4
  br label %if.end
...
for.end112:                                       ; preds = %for.cond
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %69)
