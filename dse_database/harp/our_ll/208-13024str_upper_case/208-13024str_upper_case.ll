...
@.str.3 = private unnamed_addr constant [31 x i8] c"code/208-13024str_upper_case.c\00", align 1
...
define dso_local i8* @str_upper_case(i8* %dest, i8* %src) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i32 @toupper(i32 %conv3) #6
