; ModuleID = 'code/164-30412sleep.c'
source_filename = "code/164-30412sleep.c"
...
entry:
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0))
  ret i32 0
}
