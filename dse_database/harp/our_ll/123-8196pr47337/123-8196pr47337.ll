; ModuleID = 'code/123-8196pr47337.c'
source_filename = "code/123-8196pr47337.c"
...
entry:
  ...
  %0 = load volatile i8*, i8** @w, align 8
  %call = call i32 @strcmp(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0)) #3
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx11 = getelementptr inbounds [8 x i32], [8 x i32]* %l, i64 0, i64 %idxprom10
...
for.end14:                                        ; preds = %for.cond7
  ...
  %call15 = call signext i8 @bar(i8 signext %10, i8 signext %11)
  %conv = sext i8 %call15 to i32
  store i32 %conv, i32* @d, align 4
  %12 = load i8, i8* @c, align 1
  %conv16 = sext i8 %12 to i32
  %arrayidx17 = getelementptr inbounds [8 x i32], [8 x i32]* %l, i64 0, i64 0
  %13 = load i32, i32* %arrayidx17, align 16
  %conv18 = sext i32 %13 to i64
  %call19 = call signext i16 @foo(i64 %conv18, i64 10)
  %conv20 = sext i16 %call19 to i32
  %or = or i32 1, %conv20
  %call21 = call i32 @baz(i32 %conv16, i32 %or)
  store i32 %call21, i32* @d, align 4
  %14 = load i32, i32* @d, align 4
  %conv22 = sext i32 %14 to i64
  %15 = load i32, i32* %h, align 4
  call void @fnx(i64 %conv22, i32 %15)
  %16 = load i64, i64* @e, align 8
  %17 = load i32, i32* %h, align 4
  call void @fnx(i64 %16, i32 %17)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal signext i8 @bar(i8 signext %x, i8 signext %y) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @baz(i32 %x, i32 %y) #0 {
entry:
  %retval = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define internal signext i16 @foo(i64 %x, i64 %y) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define internal void @fnx(i64 %x, i32 %y) #0 {
entry:
  %x.addr = alloca i64, align 8
  %y.addr = alloca i32, align 4
  store i64 %x, i64* %x.addr, align 8
...
if.then:                                          ; preds = %entry
  ...
  %and5 = and i64 %xor, 1
  %arrayidx6 = getelementptr inbounds [256 x i32], [256 x i32]* @a, i64 0, i64 %and5
  ...
  %arrayidx11 = getelementptr inbounds [256 x i32], [256 x i32]* @a, i64 0, i64 %and10
