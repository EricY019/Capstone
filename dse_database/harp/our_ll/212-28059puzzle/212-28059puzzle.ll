...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @srand(i32 %seed) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @randInt(i32 %min, i32 %max) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @shuffle(i32* %items, i32 %len) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32* @createRandomArray(i32 %size) #0 {
entry:
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @findDuplicate(i32* %data, i32 %len) #0 {
entry:
...
for.end:                                          ; preds = %for.cond1
  ...
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i32 %6)
  br label %for.inc6
