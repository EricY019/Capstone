...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @abs(i32 %rem) #5
  store i32 %call1, i32* %wait_time, align 4
  %1 = load i32, i32* %wait_time, align 4
  %conv = uitofp i32 %1 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %sec_wait, align 8
  %2 = load double, double* %sec_wait, align 8
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str, i64 0, i64 0), double %2)
  %3 = load i32, i32* %wait_time, align 4
  %call3 = call i32 @usleep(i32 %3)
  br label %for.inc
