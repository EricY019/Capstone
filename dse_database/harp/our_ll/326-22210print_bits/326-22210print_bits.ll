...
define dso_local void @print_bits(i32 %i) #0 {
entry:
  %i.addr = alloca i32, align 4
  %index = alloca i32, align 4
  store i32 %i, i32* %i.addr, align 4
  %0 = load i32, i32* %i.addr, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 %0)
...
entry:
  call void @print_bits(i32 16)
  call void @print_bits(i32 -16)
  call void @print_bits(i32 30)
  call void @print_bits(i32 32)
  ret i32 0
}
