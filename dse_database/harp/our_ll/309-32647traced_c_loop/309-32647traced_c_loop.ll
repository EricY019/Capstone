; ModuleID = 'code/309-32647traced_c_loop.c'
source_filename = "code/309-32647traced_c_loop.c"
...
for.end:                                          ; preds = %for.cond
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0))
  ret i32 0
}
