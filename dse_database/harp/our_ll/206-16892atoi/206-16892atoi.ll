...
define dso_local i32 @atoi(i8* %s) #0 {
entry:
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %0, i8* align 1 getelementptr inbounds ([5 x i8], [5 x i8]* @__const.main.str, i32 0, i32 0), i64 5, i1 false)
  %arraydecay = getelementptr inbounds [5 x i8], [5 x i8]* %str, i64 0, i64 0
  %call = call i32 @atoi(i8* %arraydecay)
  store i32 %call, i32* %value, align 4
  %1 = load i32, i32* %value, align 4
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i32 %1)
  ret i32 0
}
