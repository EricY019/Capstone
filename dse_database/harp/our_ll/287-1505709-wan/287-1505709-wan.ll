; ModuleID = 'code/287-1505709-wan.c'
source_filename = "code/287-1505709-wan.c"
...
for.body4:                                        ; preds = %for.cond2
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0))
  br label %for.inc
