...
@time_out = dso_local global i32 0, align 4
...
entry:
  ...
  store i32 1, i32* @time_out, align 4
  ret void
}
...
entry:
  ...
  %call = call void (i32)* @signal(i32 14, void (i32)* bitcast (void ()* @handler to void (i32)*)) #3
  %call1 = call i32 @alarm(i32 6) #3
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i64 0, i64 0))
...
land.rhs:                                         ; preds = %for.cond
  %1 = load i32, i32* @time_out, align 4
...
for.body:                                         ; preds = %land.end
  ...
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i64 0, i64 0), i32 %3)
