...
entry:
  ...
  %call1 = call i32 @pthread_detach(i64 %0) #3
  %1 = load i64, i64* %pid1, align 8
  %call2 = call i32 @pthread_join(i64 %1, i8** null)
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i64 0, i64 0))
