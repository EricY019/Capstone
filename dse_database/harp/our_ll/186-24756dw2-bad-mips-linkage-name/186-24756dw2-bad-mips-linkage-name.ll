...
entry:
  ...
  call void asm sideeffect ".global f_end_lbl\0Af_end_lbl:", "~{dirflag},~{fpsr},~{flags}"() #1, !srcloc !5
  ret i32 0
}
...
entry:
  %x.addr = alloca i8*, align 8
  store i8* %x, i8** %x.addr, align 8
  call void asm sideeffect ".global g_end_lbl\0Ag_end_lbl:", "~{dirflag},~{fpsr},~{flags}"() #1, !srcloc !6
  ret i32 0
}
