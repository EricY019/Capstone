; ModuleID = 'code/275-33285hilos.c'
source_filename = "code/275-33285hilos.c"
...
@.str.2 = private unnamed_addr constant [27 x i8] c"\0A Estes es el primer hilo\0A\00", align 1
@.str.3 = private unnamed_addr constant [27 x i8] c"\0A Este es el segundo hilo\0A\00", align 1
...
entry:
  ...
  %call1 = call i32 @pthread_equal(i64 %0, i64 %1) #5
  %tobool = icmp ne i32 %call1, 0
  br i1 %tobool, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.2, i64 0, i64 0))
  br label %if.end
