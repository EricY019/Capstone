; ModuleID = 'code/244-1795return.c'
source_filename = "code/244-1795return.c"
...
@.str = private unnamed_addr constant [19 x i8] c"My name is BohYoh.\00", align 1
@stdout = external dso_local global %struct._IO_FILE*, align 8
@.str.1 = private unnamed_addr constant [20 x i8] c"\0DHow do you do ?   \00", align 1
@.str.2 = private unnamed_addr constant [22 x i8] c"\0DThanks.            \0A\00", align 1
...
entry:
  ...
  %call2 = call i32 @sleep(i64 2000)
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0))
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8
  %call4 = call i32 @fflush(%struct._IO_FILE* %1)
  %call5 = call i32 @sleep(i64 2000)
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
