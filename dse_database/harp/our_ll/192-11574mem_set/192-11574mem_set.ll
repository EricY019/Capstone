; ModuleID = 'code/192-11574mem_set.c'
source_filename = "code/192-11574mem_set.c"
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 %1)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
