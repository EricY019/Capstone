; ModuleID = 'code/312-24043rand68.c'
source_filename = "code/312-24043rand68.c"
...
@.str.1 = private unnamed_addr constant [32 x i8] c"before stmt(%d): checksum = %X\0A\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@.str.2 = private unnamed_addr constant [35 x i8] c"...checksum after hashing %s : %X\0A\00", align 1
...
entry:
  ...
  call void @transparent_crc(i32 %0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0), i32 %1)
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %xor = xor i32 %3, -1
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i8* %2, i32 %xor)
  br label %if.end
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i64 0, i64 0), i32 %0, i64 %xor)
...
for.body:                                         ; preds = %for.cond
  call void @step_hash(i32 4)
  %1 = load i32, i32* @g_2, align 4
  %conv = trunc i32 %1 to i16
  store i16 %conv, i16* %retval, align 2
  br label %return

for.inc:                                          ; No predecessors!
  %2 = load i32, i32* @g_2, align 4
  %sub = sub nsw i32 %2, 7
  store i32 %sub, i32* @g_2, align 4
  br label %for.cond, !llvm.loop !8

for.end:                                          ; preds = %for.cond
  call void @step_hash(i32 6)
  %3 = load i32, i32* @g_2, align 4
  %conv1 = sext i32 %3 to i64
  %cmp2 = icmp ne i64 4294967295, %conv1
  %conv3 = zext i1 %cmp2 to i32
  store i32 %conv3, i32* @g_2, align 4
  call void @step_hash(i32 7)
  %4 = load i32, i32* @g_2, align 4
  %conv4 = trunc i32 %4 to i16
  store i16 %conv4, i16* %retval, align 2
  br label %return
...
if.then:                                          ; preds = %entry
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), i32 %1)
  br label %if.end
