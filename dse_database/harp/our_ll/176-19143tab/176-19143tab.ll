...
entry:
  ...
  %tab2 = alloca [100 x i32], align 16
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds [10 x i32], [10 x i32]* %t, i64 0, i64 %idxprom4
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx13 = getelementptr inbounds [100 x i32], [100 x i32]* %tab2, i64 0, i64 %idxprom12
  %12 = load i32, i32* %arrayidx13, align 4
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 %10, i32 %12)
  br label %for.inc15
