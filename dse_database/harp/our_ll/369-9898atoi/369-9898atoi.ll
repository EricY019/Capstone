...
entry:
  %s = alloca i8*, align 8
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i8** %s, align 8
  %0 = load i8*, i8** %s, align 8
  %call = call i32 @atoi(i8* %0)
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i64 0, i64 0), i32 %call)
  ret i32 0
}
