; ModuleID = 'code/332-22290tc14_laog_dinphils.c'
source_filename = "code/332-22290tc14_laog_dinphils.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.anon = type { %union.pthread_mutex_t, [80 x i8] }
...
@chop = internal global [5 x %struct.anon] zeroinitializer, align 16
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x %struct.anon], [5 x %struct.anon]* @chop, i64 0, i64 %4
  %m = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx, i32 0, i32 0
  %call = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* %m) #3
  %5 = load i64, i64* %right, align 8
  %arrayidx1 = getelementptr inbounds [5 x %struct.anon], [5 x %struct.anon]* @chop, i64 0, i64 %5
  %m2 = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx1, i32 0, i32 0
  %call3 = call i32 @pthread_mutex_lock(%union.pthread_mutex_t* %m2) #3
  %6 = load i64, i64* %left, align 8
  %arrayidx4 = getelementptr inbounds [5 x %struct.anon], [5 x %struct.anon]* @chop, i64 0, i64 %6
  %m5 = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx4, i32 0, i32 0
  %call6 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %m5) #3
  %7 = load i64, i64* %right, align 8
  %arrayidx7 = getelementptr inbounds [5 x %struct.anon], [5 x %struct.anon]* @chop, i64 0, i64 %7
  %m8 = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx7, i32 0, i32 0
  %call9 = call i32 @pthread_mutex_unlock(%union.pthread_mutex_t* %m8) #3
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [5 x %struct.anon], [5 x %struct.anon]* @chop, i64 0, i64 %1
  %m = getelementptr inbounds %struct.anon, %struct.anon* %arrayidx, i32 0, i32 0
  %call = call i32 @pthread_mutex_init(%union.pthread_mutex_t* %m, %union.pthread_mutexattr_t* null) #3
  br label %for.inc
