...
@__const.main.buf = private unnamed_addr constant [20 x i8] c"E\00\00\83\00\00@\00@\11\00\00\0AD\0C\03\FF\FF\FF\FF", align 16
...
define dso_local zeroext i16 @crc16_fast(i8* %buf, i32 %len) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [256 x i16], [256 x i16]* @crc16tbl_, i64 0, i64 %idxprom1
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @crc16_(i8* %buf, i32 %len) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  %len.addr = alloca i32, align 4
  %Y = alloca i32, align 4
...
if.then:                                          ; preds = %for.body4
  ...
  store i32 %xor5, i32* %Y, align 4
  br label %if.end

if.else:                                          ; preds = %for.body4
  %9 = load i32, i32* %Y, align 4
  %shr6 = lshr i32 %9, 1
  store i32 %shr6, i32* %Y, align 4
  br label %if.end
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @crc16_4(i8* %buf, i16 zeroext %length) #0 {
entry:
  %buf.addr = alloca i8*, align 8
  ...
  store i16 -1, i16* %shift, align 2
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %0 = load i32, i32* %i, align 4
  %1 = load i16, i16* %length.addr, align 2
...
if.end:                                           ; preds = %if.then, %for.body
  %5 = load i16, i16* %shift, align 2
  %conv6 = zext i16 %5 to i32
  %6 = load i16, i16* %data, align 2
  %conv7 = zext i16 %6 to i32
  %xor = xor i32 %conv6, %conv7
  %conv8 = trunc i32 %xor to i16
  store i16 %conv8, i16* %val, align 2
  %7 = load i16, i16* %shift, align 2
  %conv9 = zext i16 %7 to i32
  %shl10 = shl i32 %conv9, 1
  %conv11 = trunc i32 %shl10 to i16
  store i16 %conv11, i16* %shift, align 2
  %8 = load i16, i16* %data, align 2
...
for.end:                                          ; preds = %for.cond
  %12 = load i16, i16* %shift, align 2
  ret i16 %12
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @crc_ccitt(i8* %q, i32 %len) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %arrayidx = getelementptr inbounds [256 x i16], [256 x i16]* @ccitt_table, i64 0, i64 %idxprom
  %4 = load i16, i16* %arrayidx, align 2
  %conv2 = zext i16 %4 to i32
  %5 = load i16, i16* %crc, align 2
  %conv3 = zext i16 %5 to i32
  %shl = shl i32 %conv3, 8
  %xor4 = xor i32 %conv2, %shl
  %conv5 = trunc i32 %xor4 to i16
  store i16 %conv5, i16* %crc, align 2
  br label %while.cond, !llvm.loop !9

while.end:                                        ; preds = %while.cond
  %6 = load i16, i16* %crc, align 2
  %conv6 = zext i16 %6 to i32
  %neg = xor i32 %conv6, -1
  %conv7 = trunc i32 %neg to i16
  ret i16 %conv7
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @crc_dsp(i16 zeroext %reg, i8 zeroext %data_crc) #0 {
entry:
  ...
  store i8 %data_crc, i8* %data_crc.addr, align 1
  store i16 -32763, i16* %gx, align 2
  store i16 0, i16* %i, align 2
  %0 = load i8, i8* %data_crc.addr, align 1
  %conv = zext i8 %0 to i16
  store i16 %conv, i16* %data, align 2
  %1 = load i16, i16* %data, align 2
  %conv1 = zext i16 %1 to i32
  %shl = shl i32 %conv1, 8
  %conv2 = trunc i32 %shl to i16
  store i16 %conv2, i16* %data, align 2
  %2 = load i16, i16* %reg.addr, align 2
  %conv3 = zext i16 %2 to i32
  %3 = load i16, i16* %data, align 2
  %conv4 = zext i16 %3 to i32
  %xor = xor i32 %conv3, %conv4
  %conv5 = trunc i32 %xor to i16
  store i16 %conv5, i16* %reg.addr, align 2
  br label %do.body
...
do.body:                                          ; preds = %do.cond, %entry
  ...
  store i16 %conv7, i16* %msb, align 2
  %5 = load i16, i16* %reg.addr, align 2
  %conv8 = zext i16 %5 to i32
  %shl9 = shl i32 %conv8, 1
  %conv10 = trunc i32 %shl9 to i16
  store i16 %conv10, i16* %reg.addr, align 2
  %6 = load i16, i16* %msb, align 2
...
do.end:                                           ; preds = %do.cond
  %11 = load i16, i16* %reg.addr, align 2
  ret i16 %11
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @crc_16(i8* %data, i32 %len) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  %2 = load i16, i16* %crc, align 2
  %3 = load i8*, i8** %p, align 8
  %incdec.ptr = getelementptr inbounds i8, i8* %3, i32 1
  store i8* %incdec.ptr, i8** %p, align 8
  %4 = load i8, i8* %3, align 1
  %call = call zeroext i16 @crc_dsp(i16 zeroext %2, i8 zeroext %4)
  store i16 %call, i16* %crc, align 2
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @UpdateCRC16(i16 zeroext %crcIn, i8 zeroext %byte) #0 {
entry:
  %crcIn.addr = alloca i16, align 2
  %byte.addr = alloca i8, align 1
  %crc = alloca i32, align 4
  %in = alloca i32, align 4
  store i16 %crcIn, i16* %crcIn.addr, align 2
  store i8 %byte, i8* %byte.addr, align 1
  %0 = load i16, i16* %crcIn.addr, align 2
  %conv = zext i16 %0 to i32
  store i32 %conv, i32* %crc, align 4
  %1 = load i8, i8* %byte.addr, align 1
  %conv1 = zext i8 %1 to i32
  %or = or i32 %conv1, 256
  store i32 %or, i32* %in, align 4
  br label %do.body

do.body:                                          ; preds = %do.cond, %entry
  %2 = load i32, i32* %crc, align 4
  %shl = shl i32 %2, 1
  store i32 %shl, i32* %crc, align 4
  %3 = load i32, i32* %in, align 4
  %shl2 = shl i32 %3, 1
  store i32 %shl2, i32* %in, align 4
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @Cal_CRC16(i8* %data, i32 %size) #0 {
entry:
  %data.addr = alloca i8*, align 8
  ...
  store i8* %add.ptr, i8** %dataEnd, align 8
  br label %while.cond

while.cond:                                       ; preds = %while.body, %entry
  %2 = load i8*, i8** %data.addr, align 8
  %3 = load i8*, i8** %dataEnd, align 8
  %cmp = icmp ult i8* %2, %3
  br i1 %cmp, label %while.body, label %while.end
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call zeroext i16 @UpdateCRC16(i16 zeroext %conv, i8 zeroext %6)
  %conv1 = zext i16 %call to i32
  store i32 %conv1, i32* %crc, align 4
  br label %while.cond, !llvm.loop !13

while.end:                                        ; preds = %while.cond
  %7 = load i32, i32* %crc, align 4
  %conv2 = trunc i32 %7 to i16
  %call3 = call zeroext i16 @UpdateCRC16(i16 zeroext %conv2, i8 zeroext 0)
  %conv4 = zext i16 %call3 to i32
  store i32 %conv4, i32* %crc, align 4
  %8 = load i32, i32* %crc, align 4
  %conv5 = trunc i32 %8 to i16
  %call6 = call zeroext i16 @UpdateCRC16(i16 zeroext %conv5, i8 zeroext 0)
  %conv7 = zext i16 %call6 to i32
  store i32 %conv7, i32* %crc, align 4
  %9 = load i32, i32* %crc, align 4
  %and = and i32 %9, 65535
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local zeroext i16 @csum(i8* %addr, i32 %count) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  store i8* %incdec.ptr, i8** %addr.addr, align 8
...
if.then:                                          ; preds = %while.end
  ...
  store i64 %add4, i64* %sum, align 8
  br label %if.end
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %0, i8* align 16 getelementptr inbounds ([20 x i8], [20 x i8]* @__const.main.buf, i32 0, i32 0), i64 20, i1 false)
  store i32 20, i32* %len, align 4
  %arraydecay = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %1 = load i32, i32* %len, align 4
  %call = call zeroext i16 @crc16_(i8* %arraydecay, i32 %1)
  store i16 %call, i16* %cksum1, align 2
  %arraydecay1 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %2 = load i32, i32* %len, align 4
  %call2 = call zeroext i16 @crc16_fast(i8* %arraydecay1, i32 %2)
  store i16 %call2, i16* %cksum2, align 2
  %arraydecay3 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %3 = load i32, i32* %len, align 4
  %conv = zext i32 %3 to i64
  %call4 = call zeroext i16 @crc16(i16 zeroext -1, i8* %arraydecay3, i64 %conv)
  store i16 %call4, i16* %cksum3, align 2
  %arraydecay5 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %4 = load i32, i32* %len, align 4
  %conv6 = trunc i32 %4 to i16
  %call7 = call zeroext i16 @crc16_4(i8* %arraydecay5, i16 zeroext %conv6)
  store i16 %call7, i16* %cksum4, align 2
  %arraydecay8 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %5 = load i32, i32* %len, align 4
  %call9 = call zeroext i16 @crc_ccitt(i8* %arraydecay8, i32 %5)
  store i16 %call9, i16* %cksum5, align 2
  %arraydecay10 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %6 = load i32, i32* %len, align 4
  %call11 = call zeroext i16 @crc_16(i8* %arraydecay10, i32 %6)
  store i16 %call11, i16* %cksum6, align 2
  %arraydecay12 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %7 = load i32, i32* %len, align 4
  %call13 = call zeroext i16 @Cal_CRC16(i8* %arraydecay12, i32 %7)
  store i16 %call13, i16* %cksum7, align 2
  %arraydecay14 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %8 = load i32, i32* %len, align 4
  %call15 = call i32 @crc16_area(i8* %arraydecay14, i32 %8, i32 -1)
  %conv16 = trunc i32 %call15 to i16
  store i16 %conv16, i16* %cksum8, align 2
  %arraydecay17 = getelementptr inbounds [20 x i8], [20 x i8]* %buf, i64 0, i64 0
  %9 = load i32, i32* %len, align 4
  %call18 = call zeroext i16 @csum(i8* %arraydecay17, i32 %9)
  store i16 %call18, i16* %cksum9, align 2
  %10 = load i16, i16* %cksum1, align 2
  %conv19 = zext i16 %10 to i32
  %call20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i32 %conv19)
  %11 = load i16, i16* %cksum2, align 2
  %conv21 = zext i16 %11 to i32
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i64 0, i64 0), i32 %conv21)
  %12 = load i16, i16* %cksum3, align 2
  %conv23 = zext i16 %12 to i32
  %call24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.2, i64 0, i64 0), i32 %conv23)
  %13 = load i16, i16* %cksum4, align 2
  %conv25 = zext i16 %13 to i32
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i64 0, i64 0), i32 %conv25)
  %14 = load i16, i16* %cksum5, align 2
  %conv27 = zext i16 %14 to i32
  %call28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i64 0, i64 0), i32 %conv27)
  %15 = load i16, i16* %cksum6, align 2
  %conv29 = zext i16 %15 to i32
  %call30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.5, i64 0, i64 0), i32 %conv29)
  %16 = load i16, i16* %cksum7, align 2
  %conv31 = zext i16 %16 to i32
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i64 0, i64 0), i32 %conv31)
  %17 = load i16, i16* %cksum8, align 2
  %conv33 = zext i16 %17 to i32
  %call34 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7, i64 0, i64 0), i32 %conv33)
  %18 = load i16, i16* %cksum9, align 2
  %conv35 = zext i16 %18 to i32
  %call36 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.8, i64 0, i64 0), i32 %conv35)
  ret i32 0
}
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i16 @crc16(i16 zeroext %crc, i8* %buffer, i64 %len) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %3 = load i8, i8* %2, align 1
  %call = call zeroext i16 @crc16_byte(i16 zeroext %1, i8 zeroext %3)
  store i16 %call, i16* %crc.addr, align 2
  br label %while.cond, !llvm.loop !16

while.end:                                        ; preds = %while.cond
  %4 = load i16, i16* %crc.addr, align 2
  ret i16 %4
}

; Function Attrs: noinline nounwind optnone uwtable
define internal i32 @crc16_area(i8* %dbs, i32 %size, i32 %crc) #0 {
entry:
  %dbs.addr = alloca i8*, align 8
  %size.addr = alloca i32, align 4
  %crc.addr = alloca i32, align 4
  store i8* %dbs, i8** %dbs.addr, align 8
  store i32 %size, i32* %size.addr, align 4
...
while.body:                                       ; preds = %while.cond
  %1 = load i8*, i8** %dbs.addr, align 8
  %incdec.ptr = getelementptr inbounds i8, i8* %1, i32 1
  store i8* %incdec.ptr, i8** %dbs.addr, align 8
  %2 = load i8, i8* %1, align 1
  call void @crc16_b(i32* %crc.addr, i8 zeroext %2)
...
; Function Attrs: noinline nounwind optnone uwtable
define internal zeroext i16 @crc16_byte(i16 zeroext %crc, i8 zeroext %data) #0 {
entry:
  %crc.addr = alloca i16, align 2
  ...
  %1 = load i16, i16* %crc.addr, align 2
  %conv1 = zext i16 %1 to i32
  %2 = load i8, i8* %data.addr, align 1
  %conv2 = zext i8 %2 to i32
  %xor = xor i32 %conv1, %conv2
  %and = and i32 %xor, 255
  %idxprom = sext i32 %and to i64
  %arrayidx = getelementptr inbounds [256 x i16], [256 x i16]* @crc16_table, i64 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %shl = shl i32 %2, 1
  store i32 %shl, i32* %1, align 4
  %3 = load i8, i8* %db.addr, align 1
...
if.then:                                          ; preds = %for.body
  %6 = load i32*, i32** %crc.addr, align 8
...
if.end:                                           ; preds = %if.then, %for.body
  %8 = load i8, i8* %db.addr, align 1
  %conv2 = zext i8 %8 to i32
  %shr3 = ashr i32 %conv2, 1
  %conv4 = trunc i32 %shr3 to i8
  store i8 %conv4, i8* %db.addr, align 1
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  %10 = load i32*, i32** %crc.addr, align 8
  %11 = load i32, i32* %10, align 4
  %and5 = and i32 %11, 65535
  store i32 %and5, i32* %10, align 4
  ret void
}
