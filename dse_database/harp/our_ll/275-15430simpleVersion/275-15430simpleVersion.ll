...
entry:
  ...
  call void @fibonacciBuzzFizz(i32 100)
  ret i32 0
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local void @fibonacciBuzzFizz(i32 %n) #0 {
entry:
  ...
  store i64 0, i64* %fibonacci, align 8
...
if.then:                                          ; preds = %for.body
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i64 0, i64 0), i32 %4)
  br label %for.end
...
if.then3:                                         ; preds = %if.else
  ...
  store i64 %conv, i64* %fibonacci, align 8
  br label %if.end
...
if.else4:                                         ; preds = %if.else
  ...
  %add = add i64 %7, %8
  store i64 %add, i64* %fibonacci, align 8
  %9 = load i64, i64* %second, align 8
  store i64 %9, i64* %first, align 8
  %10 = load i64, i64* %fibonacci, align 8
  store i64 %10, i64* %second, align 8
  br label %if.end

if.end:                                           ; preds = %if.else4, %if.then3
  %11 = load i64, i64* %fibonacci, align 8
  %call5 = call i32 @isPrime(i64 %11)
  store i32 %call5, i32* %prime, align 4
  %12 = load i32, i32* %i, align 4
  %13 = load i64, i64* %fibonacci, align 8
  %14 = load i32, i32* %prime, align 4
  %tobool = icmp ne i32 %14, 0
  %15 = zext i1 %tobool to i64
  %cond = select i1 %tobool, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.3, i64 0, i64 0)
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i64 0, i64 0), i32 %12, i64 %13, i8* %cond)
  %16 = load i32, i32* %prime, align 4
  %tobool7 = icmp ne i32 %16, 0
  br i1 %tobool7, label %if.then10, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end
  %17 = load i64, i64* %fibonacci, align 8
  %rem = urem i64 %17, 3
  %cmp8 = icmp eq i64 %rem, 0
  br i1 %cmp8, label %if.then10, label %if.end12

if.then10:                                        ; preds = %lor.lhs.false, %if.end
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0))
  br label %if.end12

if.end12:                                         ; preds = %if.then10, %lor.lhs.false
  %18 = load i32, i32* %prime, align 4
  %tobool13 = icmp ne i32 %18, 0
  br i1 %tobool13, label %if.then18, label %lor.lhs.false14

lor.lhs.false14:                                  ; preds = %if.end12
  %19 = load i64, i64* %fibonacci, align 8
  %rem15 = urem i64 %19, 5
  %cmp16 = icmp eq i64 %rem15, 0
  br i1 %cmp16, label %if.then18, label %if.end20

if.then18:                                        ; preds = %lor.lhs.false14, %if.end12
  %call19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i64 0, i64 0))
  br label %if.end20
...
land.lhs.true:                                    ; preds = %if.end20
  %21 = load i64, i64* %fibonacci, align 8
  %rem22 = urem i64 %21, 3
  %tobool23 = icmp ne i64 %rem22, 0
  br i1 %tobool23, label %land.lhs.true24, label %if.end29

land.lhs.true24:                                  ; preds = %land.lhs.true
  %22 = load i64, i64* %fibonacci, align 8
  %rem25 = urem i64 %22, 5
  %tobool26 = icmp ne i64 %rem25, 0
  br i1 %tobool26, label %if.then27, label %if.end29

if.then27:                                        ; preds = %land.lhs.true24
  %23 = load i64, i64* %fibonacci, align 8
  %call28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i64 %23)
  br label %if.end29

if.end29:                                         ; preds = %if.then27, %land.lhs.true24, %land.lhs.true, %if.end20
  %call30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0))
  br label %if.end31
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @isPrime(i64 %num) #0 {
entry:
  %retval = alloca i32, align 4
...
for.body:                                         ; preds = %for.cond
  %8 = load i64, i64* %num.addr, align 8
