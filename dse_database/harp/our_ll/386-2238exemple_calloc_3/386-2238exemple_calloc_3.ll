...
entry:
  ...
  %bloc = alloca [1048576 x i8*], align 16
...
for.body:                                         ; preds = %for.cond
  %call = call noalias align 16 i8* @calloc(i64 1, i64 257) #3
  %1 = load i32, i32* %i, align 4
  %idxprom = sext i32 %1 to i64
  %arrayidx = getelementptr inbounds [1048576 x i8*], [1048576 x i8*]* %bloc, i64 0, i64 %idxprom
...
for.end:                                          ; preds = %if.then, %for.cond
  ...
  %call3 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0), i32 %6, i32 0)
  ret i32 0
}
