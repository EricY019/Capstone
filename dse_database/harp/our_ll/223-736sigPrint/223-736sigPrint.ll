...
define dso_local void @handler(i32 %signo) #0 {
entry:
...
entry:
  ...
  %call = call void (i32)* @signal(i32 2, void (i32)* @handler) #3
  %call1 = call void (i32)* @signal(i32 1, void (i32)* @handler) #3
  br label %while.cond
...
if.then:                                          ; preds = %while.body
  ...
  store i32 %call3, i32* %sleepTime, align 4
  br label %if.end
