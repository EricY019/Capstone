; ModuleID = 'code/388-30347initials.c'
source_filename = "code/388-30347initials.c"
...
if.then:                                          ; preds = %for.body
  %9 = load i8, i8* %inital, align 1
  %conv5 = sext i8 %9 to i32
  %call6 = call i32 @toupper(i32 %conv5) #5
  %conv7 = trunc i32 %call6 to i8
  store i8 %conv7, i8* %inital, align 1
  br label %if.end

if.end:                                           ; preds = %if.then, %for.body
  %10 = load i8, i8* %inital, align 1
  %conv8 = sext i8 %10 to i32
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %conv8)
  br label %for.inc
