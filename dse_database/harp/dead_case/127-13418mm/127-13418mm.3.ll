...
for.body7:                                        ; preds = %for.cond4
  ...
  %arrayidx = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @a, i64 0, i64 %idxprom
  %3 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %3 to i64
  %arrayidx11 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx, i64 0, i64 %idxprom10
  ...
  %arrayidx16 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @b, i64 0, i64 %idxprom15
  %5 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %5 to i64
  %arrayidx18 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx16, i64 0, i64 %idxprom17
  store double %div14, double* %arrayidx18, align 8
  %6 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %6 to i64
  %arrayidx20 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @c, i64 0, i64 %idxprom19
  %7 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %7 to i64
  %arrayidx22 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx20, i64 0, i64 %idxprom21
...
for.body46:                                       ; preds = %for.cond43
  ...
  %arrayidx48 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @c, i64 0, i64 %idxprom47
  ...
  %arrayidx52 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @a, i64 0, i64 %idxprom51
  %20 = load i32, i32* %k, align 4
  %idxprom53 = sext i32 %20 to i64
  %arrayidx54 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx52, i64 0, i64 %idxprom53
  %21 = load double, double* %arrayidx54, align 8
  %22 = load i32, i32* %k, align 4
  %idxprom55 = sext i32 %22 to i64
  %arrayidx56 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @b, i64 0, i64 %idxprom55
  %23 = load i32, i32* %j, align 4
  %idxprom57 = sext i32 %23 to i64
  %arrayidx58 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx56, i64 0, i64 %idxprom57
  %24 = load double, double* %arrayidx58, align 8
  %mul = fmul double %21, %24
  %add = fadd double %18, %mul
  %25 = load i32, i32* %i, align 4
  %idxprom59 = sext i32 %25 to i64
  %arrayidx60 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @c, i64 0, i64 %idxprom59
  %26 = load i32, i32* %j, align 4
  %idxprom61 = sext i32 %26 to i64
  %arrayidx62 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx60, i64 0, i64 %idxprom61
...
for.end71:                                        ; preds = %for.cond35
  ...
  %div90 = fdiv double 0x41E0000000000000, %conv89
...
for.body99:                                       ; preds = %for.cond96
  ...
  %arrayidx101 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* @c, i64 0, i64 %idxprom100
  %41 = load i32, i32* %j, align 4
  %idxprom102 = sext i32 %41 to i64
  %arrayidx103 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx101, i64 0, i64 %idxprom102
