...
@_g = dso_local global i8* getelementptr inbounds ([216 x i8], [216 x i8]* @.str, i32 0, i32 0), align 8
...
if.then:                                          ; preds = %for.body
  ...
  %arrayidx8 = getelementptr inbounds [315 x i64], [315 x i64]* @g, i64 0, i64 %idxprom7
...
for.inc:                                          ; preds = %for.body45
  ...
  %arrayidx49 = getelementptr inbounds [315 x i64], [315 x i64]* @g, i64 0, i64 %idxprom48
  ...
  %arrayidx52 = getelementptr inbounds [315 x i64], [315 x i64]* @g, i64 0, i64 %idxprom51
...
if.else57:                                        ; preds = %if.else15
  ...
  %arrayidx63 = getelementptr inbounds [315 x i64], [315 x i64]* @g, i64 0, i64 %idxprom62
...
if.then:                                          ; preds = %land.lhs.true4
  ...
  %arrayidx = getelementptr inbounds [315 x i64], [315 x i64]* @g, i64 0, i64 %add
...
entry:
  ...
  call void @gw(i64 0, i64 0, i64 1)
  call void @gw(i64 1, i64 0, i64 1)
  call void @gw(i64 2, i64 0, i64 2)
  call void @gw(i64 3, i64 0, i64 6)
  call void @gw(i64 4, i64 0, i64 24)
  call void @gw(i64 5, i64 0, i64 120)
  call void @gw(i64 6, i64 0, i64 720)
  call void @gw(i64 7, i64 0, i64 5040)
  call void @gw(i64 8, i64 0, i64 40320)
  call void @gw(i64 9, i64 0, i64 362880)
  call void @gw(i64 1, i64 1, i64 0)
  store i64 362880, i64* %t0, align 8
  %call2 = call i64 @gr(i64 9, i64 0)
  %mul = mul nsw i64 %call2, 7
  call void @sa(i64 %mul)
  %call3 = call i64 @gr(i64 9, i64 0)
  %mul4 = mul nsw i64 %call3, 7
  call void @sa(i64 %mul4)
  call void @sa(i64 0)
  %call5 = call i64 @gr(i64 9, i64 0)
  %mul6 = mul nsw i64 %call5, 7
  %rem = srem i64 %mul6, 10
  %call7 = call i64 @gr(i64 %rem, i64 0)
  call void @sa(i64 %call7)
  %call8 = call i64 @gr(i64 9, i64 0)
  %mul9 = mul nsw i64 %call8, 7
  %div = sdiv i64 %mul9, 10
  call void @sa(i64 %div)
  %call10 = call i64 @gr(i64 9, i64 0)
  %mul11 = mul nsw i64 %call10, 7
  %div12 = sdiv i64 %mul11, 10
  call void @sa(i64 %div12)
  br label %_1
...
_2:                                               ; preds = %if.then
  ...
  %call17 = call i64 @gr(i64 %rem16, i64 0)
  call void @sa(i64 %call17)
  %call18 = call i64 @sp()
  store i64 %call18, i64* %v0, align 8
  %call19 = call i64 @sp()
  store i64 %call19, i64* %v1, align 8
  ...
  call void @sa(i64 %div21)
  %call22 = call i64 @sr()
  call void @sa(i64 %call22)
  %call23 = call i64 @sp()
...
_3:                                               ; preds = %_9, %if.else27, %if.else
  ...
  %call31 = call i64 @sp()
  store i64 %call31, i64* %v030, align 8
  %call33 = call i64 @sp()
  store i64 %call33, i64* %v132, align 8
  %4 = load i64, i64* %v030, align 8
  call void @sa(i64 %4)
  %5 = load i64, i64* %v132, align 8
  call void @sa(i64 %5)
  %call34 = call i64 @sr()
...
_4:                                               ; preds = %if.else39
  ...
  call void @sa(i64 %add42)
  %call43 = call i64 @sp()
  store i64 %call43, i64* %t0, align 8
  %call44 = call i64 @sp()
  %6 = load i64, i64* %t0, align 8
  %sub = sub nsw i64 %call44, %6
  call void @sa(i64 %sub)
  %call45 = call i64 @sp()
  store i64 %call45, i64* %t1, align 8
  %7 = load i64, i64* %t1, align 8
  %cmp46 = icmp ne i64 %7, 0
...
_5:                                               ; preds = %_8, %if.then48
  ...
  call void @sa(i64 %sub51)
  %call52 = call i64 @sr()
  call void @sa(i64 %call52)
  %call53 = call i64 @sp()
...
_6:                                               ; preds = %if.then56
  %call58 = call i64 @sr()
  call void @sa(i64 %call58)
  %call59 = call i64 @sr()
  call void @sa(i64 %call59)
  call void @sa(i64 0)
  %call61 = call i64 @sp()
  store i64 %call61, i64* %v060, align 8
  %call63 = call i64 @sp()
  store i64 %call63, i64* %v162, align 8
  %8 = load i64, i64* %v060, align 8
  call void @sa(i64 %8)
  %9 = load i64, i64* %v162, align 8
  call void @sa(i64 %9)
  %call64 = call i64 @sr()
  %rem65 = srem i64 %call64, 10
  %call66 = call i64 @gr(i64 %rem65, i64 0)
  call void @sa(i64 %call66)
  %call68 = call i64 @sp()
  store i64 %call68, i64* %v067, align 8
  %call70 = call i64 @sp()
  store i64 %call70, i64* %v169, align 8
  %10 = load i64, i64* %v067, align 8
  call void @sa(i64 %10)
  %11 = load i64, i64* %v169, align 8
  call void @sa(i64 %11)
  %call71 = call i64 @sp()
  %div72 = sdiv i64 %call71, 10
  call void @sa(i64 %div72)
  %call73 = call i64 @sr()
  call void @sa(i64 %call73)
  br label %_1

_7:                                               ; preds = %if.else57
  %call74 = call i64 @gr(i64 1, i64 1)
  %sub75 = sub nsw i64 %call74, 3
  %call76 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i64 %sub75)
  %call77 = call i64 @sr()
  call void @sa(i64 %call77)
  %call78 = call i64 @sp()
  %call79 = call i64 @sp()
  ret i32 0
...
_8:                                               ; preds = %if.else49
  %call80 = call i64 @sr()
  %call81 = call i64 @gr(i64 1, i64 1)
  %add82 = add nsw i64 %call80, %call81
  call void @gw(i64 1, i64 1, i64 %add82)
  br label %_5

_9:                                               ; preds = %if.then38
  %call84 = call i64 @sp()
  store i64 %call84, i64* %v083, align 8
  %call86 = call i64 @sp()
  store i64 %call86, i64* %v185, align 8
  %12 = load i64, i64* %v083, align 8
  call void @sa(i64 %12)
  %13 = load i64, i64* %v185, align 8
  call void @sa(i64 %13)
  br label %_3
...
_10:                                              ; preds = %if.then26
  ...
  %call89 = call i64 @gr(i64 %rem88, i64 0)
  call void @sa(i64 %call89)
  %call91 = call i64 @sp()
  store i64 %call91, i64* %v090, align 8
  %call93 = call i64 @sp()
  store i64 %call93, i64* %v192, align 8
  %14 = load i64, i64* %v090, align 8
  call void @sa(i64 %14)
  %15 = load i64, i64* %v192, align 8
  call void @sa(i64 %15)
  %call94 = call i64 @sp()
  %div95 = sdiv i64 %call94, 10
  call void @sa(i64 %div95)
  %call96 = call i64 @sr()
  call void @sa(i64 %call96)
  br label %_1
}
