...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx11 = getelementptr inbounds [10240 x i8], [10240 x i8]* @a, i64 0, i64 %idxprom10
...
for.end:                                          ; preds = %for.cond3
  ...
  store i32 0, i32* %k13, align 4
  br label %for.cond18

for.cond18:                                       ; preds = %for.inc33, %for.end
  %15 = load i32, i32* %k13, align 4
  %16 = load i32, i32* @N4, align 4
  %cmp19 = icmp sle i32 %15, %16
  br i1 %cmp19, label %for.body21, label %for.end35

for.body21:                                       ; preds = %for.cond18
  %17 = load i32, i32* %r15, align 4
  %mul22 = mul i32 %17, 10
  %18 = load i32, i32* %k13, align 4
  %idxprom23 = sext i32 %18 to i64
  %arrayidx24 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom23
  %19 = load i8, i8* %arrayidx24, align 1
  %conv25 = sext i8 %19 to i32
  %add26 = add i32 %mul22, %conv25
  store i32 %add26, i32* %u16, align 4
  %20 = load i32, i32* %u16, align 4
  %div27 = udiv i32 %20, 239
  store i32 %div27, i32* %q14, align 4
  %21 = load i32, i32* %u16, align 4
  %22 = load i32, i32* %q14, align 4
  %mul28 = mul i32 %22, 239
  %sub29 = sub i32 %21, %mul28
  store i32 %sub29, i32* %r15, align 4
  %23 = load i32, i32* %q14, align 4
  %conv30 = trunc i32 %23 to i8
  %24 = load i32, i32* %k13, align 4
  %idxprom31 = sext i32 %24 to i64
  %arrayidx32 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom31
  store i8 %conv30, i8* %arrayidx32, align 1
  br label %for.inc33

for.inc33:                                        ; preds = %for.body21
  %25 = load i32, i32* %k13, align 4
  %inc34 = add nsw i32 %25, 1
  store i32 %inc34, i32* %k13, align 4
  br label %for.cond18, !llvm.loop !10

for.end35:                                        ; preds = %for.cond18
  store i32 0, i32* %r39, align 4
  store i32 0, i32* %k37, align 4
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc57, %for.end35
  %26 = load i32, i32* %k37, align 4
  %27 = load i32, i32* @N4, align 4
  %cmp43 = icmp sle i32 %26, %27
  br i1 %cmp43, label %for.body45, label %for.end59

for.body45:                                       ; preds = %for.cond42
  %28 = load i32, i32* %r39, align 4
  %mul46 = mul i32 %28, 10
  %29 = load i32, i32* %k37, align 4
  %idxprom47 = sext i32 %29 to i64
  %arrayidx48 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom47
  %30 = load i8, i8* %arrayidx48, align 1
  %conv49 = sext i8 %30 to i32
  %add50 = add i32 %mul46, %conv49
  store i32 %add50, i32* %u40, align 4
  %31 = load i32, i32* %u40, align 4
  %div51 = udiv i32 %31, 239
  store i32 %div51, i32* %q38, align 4
  %32 = load i32, i32* %u40, align 4
  %33 = load i32, i32* %q38, align 4
  %mul52 = mul i32 %33, 239
  %sub53 = sub i32 %32, %mul52
  store i32 %sub53, i32* %r39, align 4
  %34 = load i32, i32* %q38, align 4
  %conv54 = trunc i32 %34 to i8
  %35 = load i32, i32* %k37, align 4
  %idxprom55 = sext i32 %35 to i64
  %arrayidx56 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom55
  store i8 %conv54, i8* %arrayidx56, align 1
  br label %for.inc57

for.inc57:                                        ; preds = %for.body45
  %36 = load i32, i32* %k37, align 4
  %inc58 = add nsw i32 %36, 1
  store i32 %inc58, i32* %k37, align 4
...
for.end62:                                        ; preds = %for.cond
  ...
  store i32 0, i32* %k64, align 4
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc84, %for.end62
  %38 = load i32, i32* %k64, align 4
  %39 = load i32, i32* @N4, align 4
  %cmp70 = icmp sle i32 %38, %39
  br i1 %cmp70, label %for.body72, label %for.end86

for.body72:                                       ; preds = %for.cond69
  %40 = load i32, i32* %r66, align 4
  %mul73 = mul i32 %40, 10
  %41 = load i32, i32* %k64, align 4
  %idxprom74 = sext i32 %41 to i64
  %arrayidx75 = getelementptr inbounds [10240 x i8], [10240 x i8]* @a, i64 0, i64 %idxprom74
  %42 = load i8, i8* %arrayidx75, align 1
  %conv76 = sext i8 %42 to i32
  %add77 = add i32 %mul73, %conv76
  store i32 %add77, i32* %u67, align 4
  %43 = load i32, i32* %u67, align 4
  %div78 = udiv i32 %43, 5
  store i32 %div78, i32* %q65, align 4
  %44 = load i32, i32* %u67, align 4
  %45 = load i32, i32* %q65, align 4
  %mul79 = mul i32 %45, 5
  %sub80 = sub i32 %44, %mul79
  store i32 %sub80, i32* %r66, align 4
  %46 = load i32, i32* %q65, align 4
  %conv81 = trunc i32 %46 to i8
  %47 = load i32, i32* %k64, align 4
  %idxprom82 = sext i32 %47 to i64
  %arrayidx83 = getelementptr inbounds [10240 x i8], [10240 x i8]* @a, i64 0, i64 %idxprom82
  store i8 %conv81, i8* %arrayidx83, align 1
  br label %for.inc84

for.inc84:                                        ; preds = %for.body72
  %48 = load i32, i32* %k64, align 4
  %inc85 = add nsw i32 %48, 1
  store i32 %inc85, i32* %k64, align 4
  br label %for.cond69, !llvm.loop !13

for.end86:                                        ; preds = %for.cond69
  call void @SUBTRACT(i8* getelementptr inbounds ([10240 x i8], [10240 x i8]* @b, i64 0, i64 0), i8* getelementptr inbounds ([10240 x i8], [10240 x i8]* @c, i64 0, i64 0), i8* getelementptr inbounds ([10240 x i8], [10240 x i8]* @b, i64 0, i64 0))
  store i32 0, i32* %r90, align 4
  store i32 0, i32* %k88, align 4
  br label %for.cond93

for.cond93:                                       ; preds = %for.inc108, %for.end86
  %49 = load i32, i32* %k88, align 4
  %50 = load i32, i32* @N4, align 4
  %cmp94 = icmp sle i32 %49, %50
  br i1 %cmp94, label %for.body96, label %for.end110

for.body96:                                       ; preds = %for.cond93
  %51 = load i32, i32* %r90, align 4
  %mul97 = mul i32 %51, 10
  %52 = load i32, i32* %k88, align 4
  %idxprom98 = sext i32 %52 to i64
  %arrayidx99 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom98
  %53 = load i8, i8* %arrayidx99, align 1
  %conv100 = sext i8 %53 to i32
  %add101 = add i32 %mul97, %conv100
  store i32 %add101, i32* %u91, align 4
  %54 = load i32, i32* %u91, align 4
  %div102 = udiv i32 %54, 239
  store i32 %div102, i32* %q89, align 4
  %55 = load i32, i32* %u91, align 4
  %56 = load i32, i32* %q89, align 4
  %mul103 = mul i32 %56, 239
  %sub104 = sub i32 %55, %mul103
  store i32 %sub104, i32* %r90, align 4
  %57 = load i32, i32* %q89, align 4
  %conv105 = trunc i32 %57 to i8
  %58 = load i32, i32* %k88, align 4
  %idxprom106 = sext i32 %58 to i64
  %arrayidx107 = getelementptr inbounds [10240 x i8], [10240 x i8]* @b, i64 0, i64 %idxprom106
  store i8 %conv105, i8* %arrayidx107, align 1
  br label %for.inc108

for.inc108:                                       ; preds = %for.body96
  %59 = load i32, i32* %k88, align 4
  %inc109 = add nsw i32 %59, 1
  store i32 %inc109, i32* %k88, align 4
  br label %for.cond93, !llvm.loop !14
