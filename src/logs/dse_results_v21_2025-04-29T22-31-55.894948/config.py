...
parser.add_argument('--save_freq', default=save_freq)
parser.add_argument('--val_freq', default=val_freq)
parser.add_argument('--test_freq', default=test_freq)
...
# model_path = None
model_path = "/home/jwyang/pretrain_pipeline/models/v21/regression_pragma_as_MLP_2l-m-2l-p_model_state_dict.pth" #TODO:new path
model_path_list = []
# use_pretrain = True 
use_pretrain = False
if use_pretrain:
